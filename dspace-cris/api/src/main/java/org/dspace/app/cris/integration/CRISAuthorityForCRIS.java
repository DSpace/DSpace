 ...
 * @author cilea
 */
public abstract class CRISAuthorityForCRIS<T extends ACrisObject> implements ChoiceAuthority, ChoiceAuthorityDetails
{
    /** The logger */
    private static Logger log = Logger.getLogger(CRISAuthorityForCRIS.class);
            ...
            int start, int limit, String locale)
    {
        ...
        {
            log.error("Error quering the CRISAuthorityForCRIS - " + e.getMessage(), e);
