		...
		<div class="bottom">
			...
			<div class="list-group">
				...
				<c:if test="${child.type eq 3}">
					<a class="list-group-item" href="${contextPath}/cris/stats/collection.html?handle=${child.handle}&type=${type}&stats_from_date=${data.stats_from_date}&stats_to_date=${data.stats_to_date}"><fmt:message key="view.${data.jspKey}.${type}.childrenStats"><fmt:param>${child.name}</fmt:param></fmt:message></a>
				</c:if>
				<c:if test="${child.type eq 4}">
					<a class="list-group-item" href="${contextPath}/cris/stats/community.html?handle=${child.handle}&type=${type}&stats_from_date=${data.stats_from_date}&stats_to_date=${data.stats_to_date}"><fmt:message key="view.${data.jspKey}.${type}.childrenStats"><fmt:param>${child.name}</fmt:param></fmt:message></a>
				</c:if>	
				</c:forEach>
			</div>
		</div>
