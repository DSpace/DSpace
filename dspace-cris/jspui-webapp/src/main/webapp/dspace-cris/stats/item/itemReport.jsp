...
<div class="bottom">
			<c:if test="${data.seeParentObject}">			
				<c:set var="parentLink">${contextPath}/stats/collection.html?handle=${data.parentObject.handle}&type=${type}&stats_from_date=${data.stats_from_date}&stats_to_date=${data.stats_to_date}</c:set>
