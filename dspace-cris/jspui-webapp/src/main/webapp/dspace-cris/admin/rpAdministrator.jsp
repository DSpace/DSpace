...
<dspace:layout locbar="link" style="submission" navbar="admin" titlekey="jsp.dspace-admin.rp">
			<h1><fmt:message key="jsp.dspace-admin.rp" />
			<a target="_blank"
	...
	<ul class="blank-page">
		<li>
		<a href="<%=request.getContextPath()%>/cris/administrator/rp/listTabs.htm"><fmt:message
			key="jsp.dspace-admin.hku.jdyna-configuration.listtabs" /></a>	
		</li>
		<li>
		<a href="<%=request.getContextPath()%>/cris/administrator/rp/listEditTabs.htm"><fmt:message
			key="jsp.dspace-admin.hku.jdyna-configuration.listedittabs" /></a>	
		</li>
		<li>
			<a href="<%=request.getContextPath()%>/cris/administrator/rp/listBoxs.htm"><fmt:message
			key="jsp.dspace-admin.hku.jdyna-configuration.listboxs" /></a>	
		</li>
		<li>
		<a id="addentity"
			href="#"><fmt:message
			key="jsp.dspace-admin.hku.add-researcher" /></a>	
		...
		<a
			...
			key="jsp.dspace-admin.hku.see-researchers" /></a>
		</li>
	</ul>
</dspace:layout>
