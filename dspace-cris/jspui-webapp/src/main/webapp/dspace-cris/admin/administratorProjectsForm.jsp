...
<dspace:layout locbar="link" style="submission" navbar="admin" titlekey="jsp.dspace-admin.projects-list">
<h1><fmt:message key="jsp.dspace-admin.projects-list" />
<a target="_blank"
	...
	<c:remove var="messages" scope="session" />
		...
		<display:table name="${dto}" cellspacing="0" cellpadding="0" 
			...
			<display:column headerClass="sourceID" class="sourceID" titleKey="jsp.layout.table.cris.admin-list.sourceID" sortable="false">
							<a href="<%=request.getContextPath()%>/cris/pj/details.htm?code=${objectList.sourceID}&ref=${objectList.grant.sourceRef}">${objectList.sourceID}</a>
			</display:column>					
