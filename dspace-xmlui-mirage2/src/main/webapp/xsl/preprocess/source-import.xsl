...
<xsl:stylesheet
    ...
    <xsl:template match="dri:div[@id='aspect.administrative.importer.external.LiveImportResult.div.record-left']">
        <div>
    ...
    <xsl:template match="dri:div[@id='aspect.administrative.importer.external.LiveImportResult.div.record-right']">
        <div>
            <xsl:call-template name="copy-attributes"/>
            <xsl:attribute name="rend">
