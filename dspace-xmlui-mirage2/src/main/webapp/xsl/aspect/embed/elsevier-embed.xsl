    ...
    <xsl:template match="dri:div[@n='ElsevierEmbed']">
        ...
        <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0">
            ...
            <xsl:attribute name="src">
                ...
                <xsl:text>/</xsl:text>
                <xsl:value-of select="//dri:field[@id='aspect.embed.ElsevierEmbed.field.embeddedType']"/>
                <xsl:text>/</xsl:text>
                <xsl:value-of select="//dri:field[@id='aspect.embed.ElsevierEmbed.field.identifier']"/>
