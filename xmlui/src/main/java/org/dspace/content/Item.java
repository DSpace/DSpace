        ...
        if (dublinCoreChanged)
        {
            ...
            for (int dcIdx = 0; dcIdx < getMetadata().size(); dcIdx++)
            {
                ...
                if (!storedDC[dcIdx])
                {
                    ...
                    //////////////////////////////////////////////////////
                    // Se invoca a una validación de los metadatos, para detectar
                    // cuando se guarda un metadato sin authority, pero con confidence
                    //////////////////////////////////////////////////////
                    ar.edu.unlp.sedici.util.MetadataAuthorityChecker.checkMetadata(metadata);
