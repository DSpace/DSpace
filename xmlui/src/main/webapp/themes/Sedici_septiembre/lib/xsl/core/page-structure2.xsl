        ...
        <div id="ds-header-wrapper">
            <div id="ds-header" class="clearfix">
                <a id="ds-header-logo-link">
                    ...
                    <span id="ds-header-logo-text">Putooooooooooo</span>
                </a>
...
-->
    ...
    <xsl:template name="inicio" match="dri:div[@id='file.news.div.news']" priority="2">
    ...
    <xsl:template name="busqueda_inicio" match="dri:div[@id='aspect.artifactbrowser.FrontPageSearch.div.front-page-search']" priority="2">
        <xsl:param name="muestra">false</xsl:param>    
        <xsl:if test="$muestra = 'true'">
        <div id='busqueda_inicio'>&#160;</div>
        </xsl:if>
    </xsl:template>
