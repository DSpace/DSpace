...
public class CollectionRestControllerIT extends AbstractControllerIntegrationTest {
    ...
    public void createLogoNotLoggedIn() throws Exception {
        getClient().perform(
                MockMvcRequestBuilders.fileUpload(getUrlTemplate(childCollection.getID().toString()))
                        .file(bitstreamFile))
    ...
    public void createLogo() throws Exception {
        ...
        MvcResult mvcGetResult = getClient().perform(get(getUrlTemplate(childCollection.getID().toString())))
    ...
    public void deleteLogoNotLoggedIn() throws Exception {
        ...
        getClient().perform(delete(getUrlTemplate(childCollection.getID().toString())))
                .andExpect(status().isUnauthorized());
    }
    ...
    public void deleteLogo() throws Exception {
        ...
        getClient(adminAuthToken).perform(delete(getUrlTemplate(childCollection.getID().toString())))
    ...
    public void deleteLogoNoRights() throws Exception {
        ...
        String userToken = getAuthToken(eperson.getEmail(), password);
        getClient(userToken).perform(delete(getUrlTemplate(childCollection.getID().toString())))
                .andExpect(status().isForbidden());
    }
