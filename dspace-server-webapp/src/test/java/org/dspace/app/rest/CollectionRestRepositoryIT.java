...
public class CollectionRestRepositoryIT extends AbstractControllerIntegrationTest {
    ...
    public void findAuthorizedCollectionsWithQueryAndPaginationTest() throws Exception {
        ...
        getClient(tokenAdmin).perform(get("/api/core/collections/search/findSubmitAuthorized")
                ...
                .andExpect(status().isOk())
                .andExpect(content().contentType(contentType))
                .andExpect(jsonPath("$._embedded.collections").isArray())
                .andExpect(jsonPath("$._embedded.collections[0].type", is("collection")))
                .andExpect(jsonPath("$._embedded.collections[1].type", is("collection")))
                .andExpect(jsonPath("$._embedded.collections[2]").doesNotExist())
                .andExpect(jsonPath("$.page.size", is(2)))
                .andExpect(jsonPath("$.page.totalPages", is(3)))
                .andExpect(jsonPath("$.page.number", is(0)))
        ...
        getClient(tokenAdmin).perform(get("/api/core/collections/search/findSubmitAuthorized")
                ...
                .andExpect(content().contentType(contentType))
                .andExpect(jsonPath("$._embedded.collections[0].type", is("collection")))
                .andExpect(jsonPath("$._embedded.collections[1]").doesNotExist())
                .andExpect(jsonPath("$.page.size", is(2)))
                .andExpect(jsonPath("$.page.totalPages", is(3)))
                .andExpect(jsonPath("$.page.number", is(2)))
                .andExpect(jsonPath("$.page.totalElements", is(5)));
