...
public class SuggestionRestRepositoryIT extends AbstractControllerIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        colPeople = CollectionBuilder.createCollection(context, parentCommunity).withName("People").build();
    ...
    public void findAllTest() throws Exception {
        context.turnOffAuthorisationSystem();
        Item itemFirst = ItemBuilder.createItem(context, colPeople).withTitle("Bollini, Andrea")
