...
public class ResourcePolicyRestRepositoryIT extends AbstractControllerIntegrationTest {
    ...
    public void findResourcePoliciesOfOneResourcePaginationTest() throws Exception {
        ...
        getClient(authToken).perform(get("/api/authz/resourcepolicies/search/resource")
                ...
                .andExpect(status().isOk())
                .andExpect(content().contentType(contentType))
                .andExpect(jsonPath("$._embedded.resourcepolicies[0].type", is("resourcepolicy")))
                .andExpect(jsonPath("$._embedded.resourcepolicies[1].type", is("resourcepolicy")))
                .andExpect(jsonPath("$._embedded.resourcepolicies[2]").doesNotExist())
                .andExpect(jsonPath("$.page.totalElements", is(5)))
                .andExpect(jsonPath("$.page.totalPages", is(3)))
        ...
        getClient(authToken).perform(get("/api/authz/resourcepolicies/search/resource")
                ...
                .andExpect(content().contentType(contentType))
                .andExpect(jsonPath("$._embedded.resourcepolicies[0].type", is("resourcepolicy")))
                .andExpect(jsonPath("$._embedded.resourcepolicies[1]").doesNotExist())
                .andExpect(jsonPath("$.page.totalElements", is(5)))
                .andExpect(jsonPath("$.page.totalPages", is(3)))
