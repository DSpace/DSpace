...
/**
 * Integration tests for {@link DynamicLayoutBoxConverter}.
 *
 * @author Luca Giamminonni (luca.giamminonni at 4science.it)
 *
 */
public class DynamicLayoutBoxConverterIT extends AbstractControllerIntegrationTest {

    @Autowired
    private DynamicLayoutBoxConverter converter;
    ...
    public void testMetadataBoxConversion() throws Exception {
        ...
        DynamicLayoutField titleField = DynamicLayoutFieldBuilder.createMetadataField(context, title, 0, 0, 1)
            .withLabel("Title")
            .withLabelStyle("bold")
        ...
        DynamicLayoutField issuedDate = DynamicLayoutFieldBuilder.createMetadataField(context, date, 0, 0, 0)
            .withLabel("Date")
        ...
        DynamicLayoutField languageField = DynamicLayoutFieldBuilder.createMetadataField(context, language, 0, 1, 0)
            .withLabel("Language")
            .withLabelAsHeading(false)
            .withValuesInline(false)
            .build();

        DynamicLayoutField image = DynamicLayoutFieldBuilder.createBistreamField(context, null, "ORIGINAL", 1, 0, 0)
        ...
        assertThat(rest.getConfiguration(), instanceOf(DynamicLayoutMetadataConfigurationRest.class));

        DynamicLayoutMetadataConfigurationRest config =
            (DynamicLayoutMetadataConfigurationRest) rest.getConfiguration();
    ...
    public void testRelationBoxConversion() throws Exception {
        ...
        assertThat(rest.getConfiguration(), instanceOf(DynamicLayoutBoxRelationConfigurationRest.class));

        DynamicLayoutBoxRelationConfigurationRest config = (DynamicLayoutBoxRelationConfigurationRest) rest
            .getConfiguration();
    ...
    public void testVersioningBoxConversion() throws Exception {
        ...
        DynamicLayoutBox box = DynamicLayoutBoxBuilder.createBuilder(context, entityType, true, true)
            ...
            .withType(DynamicLayoutBoxTypes.VERSIONING.name())
        ...
        DynamicLayoutBoxRest rest = converter.convert(box, Projection.DEFAULT);
        assertThat(rest, notNullValue());
        assertThat(rest.getBoxType(), is(DynamicLayoutBoxTypes.VERSIONING.name()));
