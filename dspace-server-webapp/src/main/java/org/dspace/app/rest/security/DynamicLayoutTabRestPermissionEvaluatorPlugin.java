...
/**
 * This class will handle calls made to DynamicLayoutTabRest endpoints.
 * 
 * @author Danilo Di Nuzzo (danilo.dinuzzo at 4science.it)
 *
 */
@Component
public class DynamicLayoutTabRestPermissionEvaluatorPlugin extends RestObjectPermissionEvaluatorPlugin {
    ...
    public boolean hasDSpacePermission(Authentication authentication, Serializable targetId, String targetType,
        ...
        if (!StringUtils.equalsIgnoreCase(DynamicLayoutTabRest.NAME, targetType)) {
            return false;
        }
        return true;
    }
