...
/**
 * Implementation for NotifyService Outbound patterns Constraint Replace patches.
 *
 * Example: <code>
 ...
 */
@Component
public class NotifyServiceOutboundPatternConstraintReplaceOperation extends PatchOperation<NotifyServiceEntity> {
    ...
    public NotifyServiceEntity perform(Context context, NotifyServiceEntity notifyServiceEntity, Operation operation) {
        ...
        if (supports(notifyServiceEntity, operation)) {
            try {
                ...
                checkModelForExistingValue(outboundPattern);
            ...
            throw new DSpaceBadRequestException(
                "NotifyServiceOutboundPatternConstraintReplaceOperation does not support this operation");
        }
    }

    private void checkModelForExistingValue(NotifyServiceOutboundPattern outboundPattern) {
