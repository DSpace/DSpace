...
/**
 * Implementation for NotifyService Outbound patterns Replace One patches.
 *
 * Example: <code>
 ...
 */
@Component
public class NotifyServiceOutboundPatternReplaceOperation extends PatchOperation<NotifyServiceEntity> {
    ...
    public NotifyServiceEntity perform(Context context, NotifyServiceEntity notifyServiceEntity, Operation operation) {
        ...
        if (supports(notifyServiceEntity, operation)) {
            try {
                ...
                NotifyServiceOutboundPattern existedOutboundPattern = outboundPatterns.get(index);

                existedOutboundPattern.setPattern(patchOutboundPattern.getPattern());
                existedOutboundPattern.setConstraint(patchOutboundPattern.getConstraint());
                outboundPatternService.update(context, existedOutboundPattern);
            ...
            throw new DSpaceBadRequestException(
                "NotifyServiceOutboundPatternReplaceOperation does not support this operation");
        }
    }
