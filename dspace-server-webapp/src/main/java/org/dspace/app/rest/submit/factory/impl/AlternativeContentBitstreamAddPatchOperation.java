...
/**
 * Submission "add" PATCH operation to add bitstream alternative content metadata tag.
 *
 * @author Oscar Chacón (oscar at escire.net)
 */
public class AlternativeContentBitstreamAddPatchOperation extends MetadataValueAddPatchOperation<Bitstream> {

    private static final String ALTERNATIVE_CONTENT_METADATA_NAME = "dc.type";
    private static final String ALTERNATIVE_CONTENT_METADATA_VALUE = "alternative content";
        ...
        for (Bundle bb : bundle) {
            ...
            for (Bitstream b : bb.getBitstreams()) {
                if (idx == Integer.parseInt(split[1])) {
                    ...
                    object.setValue(ALTERNATIVE_CONTENT_METADATA_VALUE);

                    addValue(context, b, ALTERNATIVE_CONTENT_METADATA_NAME, object, -1);
                }
                idx++;
            }
        }
