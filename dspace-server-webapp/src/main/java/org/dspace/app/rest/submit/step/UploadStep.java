...
public class UploadStep extends AbstractProcessingStep
    ...
    private static final Pattern ALTERNATIVE_CONTENT_PATTERN =
        Pattern.compile("^/sections/[^/]+/alternativecontent$");
    ...
    public void doPatchProcessing(Context context, HttpServletRequest currentRequest, InProgressSubmission source,
        ...
        if ("remove".equals(op.getOp())) {
            ...
            } else if (ALTERNATIVE_CONTENT_PATTERN.matcher(op.getPath()).matches()) {
