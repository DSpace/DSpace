...
/**
 * This is the Repository that takes care of the retrieval of the oldest Version object
 * for a given {@link VersionHistory}
 *
 * @author Mykhaylo Boychuk (mykhaylo.boychuk at 4science.it)
 */
@Component(VersionHistoryRest.CATEGORY + "." + VersionHistoryRest.NAME + "." + VersionHistoryRest.OLDEST_VERSION)
public class VersionHistoryOldestVersionLinkRepository extends AbstractDSpaceRestRepository
    ...
    public VersionRest getOldestVersion(@Nullable HttpServletRequest request,
        ...
        Version oldestVersion = versionHistoryService.getFirstVersion(context, versionHistory);
