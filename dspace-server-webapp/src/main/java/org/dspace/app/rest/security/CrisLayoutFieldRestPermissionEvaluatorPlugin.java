...
/**
 * This class will handle calls made to CrisLayoutBoxRest endpoints.
 * 
 * @author Danilo Di Nuzzo (danilo.dinuzzo at 4science.it)
 *
 */
@Component
public class CrisLayoutFieldRestPermissionEvaluatorPlugin extends RestObjectPermissionEvaluatorPlugin {
    ...
    public boolean hasDSpacePermission(Authentication authentication, Serializable targetId, String targetType,
        ...
        if (!StringUtils.equalsIgnoreCase(CrisLayoutFieldRest.NAME, targetType)) {
            return false;
        }
        return true;
    }
