 ...
 */
@Component
public class DynamicLayoutTabReplaceOperation<D> extends PatchOperation<D> {
    ...
    public D perform(Context context, D resource, Operation operation) throws SQLException {
        ...
        if (supports(resource, operation)) {
            DynamicLayoutTab tab = (DynamicLayoutTab) resource;
            ...
            ("DynamicLayoutTabReplaceOperation does not support this operation");
        }
        return resource;
    }
    ...
    public boolean supports(Object objectToMatch, Operation operation) {
        return (objectToMatch instanceof DynamicLayoutTab
