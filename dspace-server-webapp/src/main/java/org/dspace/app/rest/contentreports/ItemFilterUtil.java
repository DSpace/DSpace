...
public class ItemFilterUtil {
    ...
    static boolean hasMetadataMatch(Item item, String fieldList, Pattern regex) {
        if ("*".equals(fieldList)) {
            for (MetadataValue md : itemService.getMetadata(item, org.dspace.content.Item.ANY,
                    org.dspace.content.Item.ANY, org.dspace.content.Item.ANY, org.dspace.content.Item.ANY)) {
