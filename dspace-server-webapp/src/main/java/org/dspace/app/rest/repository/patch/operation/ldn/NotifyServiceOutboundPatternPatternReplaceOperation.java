...
/**
 * Implementation for NotifyService Outbound patterns Pattern Replace patches.
 *
 * Example: <code>
 ...
 */
@Component
public class NotifyServiceOutboundPatternPatternReplaceOperation extends PatchOperation<NotifyServiceEntity> {
    ...
    public NotifyServiceEntity perform(Context context, NotifyServiceEntity notifyServiceEntity, Operation operation) {
        ...
        if (supports(notifyServiceEntity, operation)) {
            ...
            throw new DSpaceBadRequestException(
                "NotifyServiceOutboundPatternPatternReplaceOperation does not support this operation");
        }
    }
