...
/**
 * This class will handle calls made to CrisLayoutMetadataComponentRest endpoints.
 * 
 * @author Danilo Di Nuzzo (danilo.dinuzzo at 4science.it)
 *
 */
@Component
public class CrisLayoutMetadataComponentRestPermissionEvaluatorPlugin extends RestObjectPermissionEvaluatorPlugin {
    ...
    public boolean hasDSpacePermission(Authentication authentication, Serializable targetId, String targetType,
        ...
        if (!StringUtils.equalsIgnoreCase(CrisLayoutMetadataComponentRest.NAME, targetType)) {
            return false;
        }
        return true;
    }
