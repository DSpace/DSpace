...
public class DiscoveryConfigurationSearchFilterLinkRepository extends AbstractDSpaceRestRepository
    ...
    public Page<DiscoveryConfigurationRest> getSearchFilters(@Nullable HttpServletRequest request,
                                                           UUID itemId,
                                                           @Nullable Pageable optionalPageable,
                                                           Projection projection) {
        throw new NotImplementedException(
            "DiscoveryConfigurationSearchFilterLinkRepository.getSearchFilters() not implemented");
    }
}
