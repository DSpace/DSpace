...
public class ListSetsTest extends DryadXoaiRegressionTest
{
    public ListSetsTest() {
        super();
    }
    ...
    public void testListSets() throws IOException, JDOMException {
        ...
        map.put("verb", Arrays.asList("ListSets"));
        ...
        File expectedFile = new File(this.getClass().getResource("/responses/ListSets.xml").getFile());
