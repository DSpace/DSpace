...
public class DSpaceIdentify extends AbstractIdentify {
	...
	public String getBaseUrl() {
		if (_baseUrl == null) {
			_baseUrl = _request.getRequestURL().toString().replace(_request.getPathInfo(), "");
		}
	...
	public Date getEarliestDate() {
		...
		try {
			TableRowIterator iterator = DatabaseManager.query(_context, 
					...
					MetadataFieldManager.getFieldID(_context, "dc.date.available"));
