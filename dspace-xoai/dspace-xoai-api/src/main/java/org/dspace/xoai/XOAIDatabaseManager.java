...
public class XOAIDatabaseManager {
	public static List<Integer> getAllSubCollections (Context ct, int i) throws SQLException {
	...
	public static List<Community> flatParentCommunities (Collection c) throws SQLException {
