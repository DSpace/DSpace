...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="cerif:Project">
		<dim:dim>
			<dim:field mdschema="dc" element="title" ><xsl:value-of select="cerif:Title" /></dim:field>
			<dim:field mdschema="oairecerif" element="acronym"><xsl:value-of select="cerif:Acronym" /></dim:field>
			<dim:field mdschema="crispj" element="openaireid" ><xsl:value-of select="cerif:Identifier[@type = 'http://namespace.openaire.eu/oaf']" /></dim:field>
			<dim:field mdschema="oairecerif" element="identifier" qualifier="url" ><xsl:value-of select="cerif:Identifier[@type = 'URL']" /></dim:field>
			<dim:field mdschema="oairecerif" element="project" qualifier="startDate" ><xsl:value-of select="cerif:StartDate" /></dim:field>
			<dim:field mdschema="oairecerif" element="project" qualifier="endDate" ><xsl:value-of select="cerif:EndDate" /></dim:field>
			<dim:field mdschema="oairecerif" element="project" qualifier="status" ><xsl:value-of select="cerif:Status" /></dim:field>
		</dim:dim>
	</xsl:template>
