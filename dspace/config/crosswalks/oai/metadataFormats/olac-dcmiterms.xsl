...
<xsl:stylesheet 
    ...
    <xsl:template name="OLAC_DCMI">
        <olac:OLAC-DcmiTerms>
            ...
            <!-- alternative -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='title']/doc:element[@name='alternative']/doc:element/doc:field[@name='value'])">
                <olac:alternative><xsl:value-of select="."/></olac:alternative>
            </xsl:for-each>
            <!-- available -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='date']/doc:element[@name='available']/doc:element/doc:field[@name='value'])">
                <olac:available><xsl:value-of select="."/></olac:available>
            </xsl:for-each>
            <!-- citation -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='identifier']/doc:element[@name='citation']/doc:element/doc:field[@name='value'])">
            ...
            <!-- created -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='date']/doc:element[@name='copyright']/doc:element/doc:field[@name='value'])">
            ...
            <!-- date -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='date']/doc:element[@name='accessioned' or @name='updated']/doc:element/doc:field[@name='value']|doc:metadata/doc:element[@name='dc']/doc:element[@name='date']/doc:element/doc:field[@name='value'])">
            ...
            <!-- extent -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='format']/doc:element[@name='extent']/doc:element/doc:field[@name='value'])">
                <olac:extent><xsl:value-of select="."/></olac:extent>
            </xsl:for-each>
            <!-- format -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='format']/doc:element[@name='mimetype']/doc:element/doc:field[@name='value']|doc:metadata/doc:element[@name='dc']/doc:element[@name='format']/doc:element/doc:field[@name='value'])">
                <olac:format><xsl:value-of select="."/></olac:format>
            </xsl:for-each>
            <!-- haspart -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='haspart']/doc:element/doc:field[@name='value'])">
                <olac:hasPart><xsl:value-of select="."/></olac:hasPart>
            </xsl:for-each>
            <!-- hasversion -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='hasversion']/doc:element/doc:field[@name='value'])">
            ...
            <!-- isformatof -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='isformatof']/doc:element/doc:field[@name='value'])">
                <olac:isFormatOf><xsl:value-of select="."/></olac:isFormatOf>
            </xsl:for-each>
            <!-- ispartof -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='ispartof']/doc:element/doc:field[@name='value'])">
                <olac:isPartOf><xsl:value-of select="."/></olac:isPartOf>
            </xsl:for-each>
            <!-- isreferencedby -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='isreferencedby']/doc:element/doc:field[@name='value'])">
            ...
            <!-- issued -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='date']/doc:element[@name='issued']/doc:element/doc:field[@name='value'])">
                <olac:issued><xsl:value-of select="."/></olac:issued>
            </xsl:for-each>
            <!-- isversionof -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='isversionof']/doc:element/doc:field[@name='value'])">
                <olac:isVersionOf><xsl:value-of select="."/></olac:isVersionOf>
            </xsl:for-each>
            <!-- language -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='language']//doc:field[@name='value'])">
                <olac:language><xsl:attribute name="olac-language"><xsl:value-of select="."/></xsl:attribute><xsl:value-of select="."/></olac:language>
            </xsl:for-each>
            <!-- medium -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='format']/doc:element[@name='medium']/doc:element/doc:field[@name='value'])">
            ...
            <!-- relation -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='ispartofseries' or @name='isbasedon' or @name='uri']/doc:element/doc:field[@name='value']|doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element/doc:field[@name='value'])">
            ...
            <!-- requires -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='requires']/doc:element/doc:field[@name='value'])">
            ...
            <!-- source -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='source']/doc:element[@name='uri']/doc:element/doc:field[@name='value']|doc:metadata/doc:element[@name='dc']/doc:element[@name='source']/doc:element/doc:field[@name='value'])">
                <olac:source><xsl:value-of select="."/></olac:source>
            </xsl:for-each>
            <!-- spatial -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='coverage']/doc:element[@name='spatial']/doc:element/doc:field[@name='value'])">
            ...
            <!-- toc -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='description']/doc:element[@name='tableofcontents']/doc:element/doc:field[@name='value'])">
                <olac:tableOfContents><xsl:value-of select="."/></olac:tableOfContents>
            </xsl:for-each>
            <!-- temporal -->
            <xsl:for-each select="xalan:distinct(doc:metadata/doc:element[@name='dc']/doc:element[@name='coverage']/doc:element[@name='temporal']/doc:element/doc:field[@name='value'])">
