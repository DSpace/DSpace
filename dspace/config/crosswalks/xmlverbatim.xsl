<!--
	...
	Modified by Leigh Dodds 03/09/2000
	1. Added anchors to each element, attribute, etc. This allows individual 
	parts of the XML to be referenced within the HTML.
