                    ...
                    <div id="below-header">
                        ...
                        <div id="mainNav">
                            <ul id="ds-trail">
                                <!--
                                    <li>
                                    <a href="http://library.tamu.edu">Library Home</a>
                                ...
                                <li>
                                    <!-- <a href="http://library.tamu.edu">Library</a>
                                        <span style="color: white; font-size: 110%;">&#8594;</span> -->
                                    <a href="http://dl.tamu.edu">Digital Library</a>
                                    <span style="color: white; font-size: 110%;">→</span>
                                </li>
                                <xsl:apply-templates select="/dri:document/dri:meta/dri:pageMeta/dri:trail">
    ...
    <xsl:template name="buildFooter">
        <div id="ds-footer">
            ...
            <div id="ds-footer-internal-wrapper">
                <a id="ds-footer-logo-anchor" href="http://www.qatar.tamu.edu">                            
                    <!-- <span id="ds-footer-logo">&#130;</span> -->
                    <img id="ds-footer-logo" src="{$theme-path}/logo_footer-1.jpg"/>
                </a>
                <p>
                    <a href="https://directory.qatar.tamu.edu/search/" class="footer" target="_blank">Campus Directory</a> | 
                    <a href="http://www.qatar.tamu.edu/technology/default_resources.aspx" target="_blank" class="footer">Online Resources</a> | 
                    <a href="http://library.tamu.edu/about/general-information/legal-notices/web-site-privacy-statement" class="footer">Privacy Policy</a> | 
                    <a href="mailto:webmaster@qatar.tamu.edu" class="footer">TAMUQ Webmaster</a> | 
                    
                    <br/>
                    
                    <a href="http://tamusystem.tamu.edu/" target="_blank" class="footer">Texas A&amp;M University System</a> | 
                    <a href="http://www.tamu.edu" target="_blank" class="footer">Texas A&amp;M University</a> | 
                    <a href="http://www.qf.edu.qa" target="_blank" class="footer">Qatar Foundation</a>
                </p>
