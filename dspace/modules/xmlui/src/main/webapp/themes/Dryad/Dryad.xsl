...
to lead the user through the submission -->
    ...
    <xsl:template match="dri:list[@n='doi']">
        ...
        <li id="aspect_submission_StepTransformer_list_doi">
            ...
            <!-- style="border: 2px solid gray; float:right; display:inline-block" -->
            <div>
    ...
    <!-- END First submission form: added and rewrote some templates to manage the form using jquery,
to lead the user through the submission -->
