...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:import href="../Mirage/lib/xsl/core/global-variables.xsl"/>
    <xsl:import href="lib/xsl/core/page-structure.xsl"/>
    <xsl:import href="../Mirage/lib/xsl/core/navigation.xsl"/>
    <xsl:import href="../Mirage/lib/xsl/core/elements.xsl"/>
    <xsl:import href="lib/xsl/core/forms.xsl"/>
    <xsl:import href="../Mirage/lib/xsl/core/attribute-handlers.xsl"/>
    <xsl:import href="../Mirage/lib/xsl/core/utils.xsl"/>
    <xsl:import href="lib/xsl/aspect/general/choice-authority-control.xsl"/>
    <xsl:import href="../Mirage/lib/xsl/aspect/administrative/administrative.xsl"/>
    <xsl:import href="lib/xsl/aspect/artifactbrowser/item-list.xsl"/>
    <xsl:import href="lib/xsl/aspect/artifactbrowser/item-view.xsl"/>
    <xsl:import href="../Mirage/lib/xsl/aspect/artifactbrowser/community-list.xsl"/>
    <xsl:import href="../Mirage/lib/xsl/aspect/artifactbrowser/collection-list.xsl"/>
