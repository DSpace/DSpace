...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template match="dri:options">
        <div id="ds-options-wrapper">
            <div id="ds-options">
                ...
                <!-- SILENCE ACCOUNT BOX: Avoids the rendering of the user-account box. -->
    ...
    <!-- This template controls the display of the Discovery FACET'S box. Avoids to show the box in the "Homepage"-->
