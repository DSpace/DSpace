            ...
            <div class="home-col-2" style="clear: both; margin-left: 25px;">
                ...
                <div id="recently_integrated_journals" class="ds-static-div primary">
                    <div class="container">
                        ...
                        <a class="single-image-link" href="/discover?field=prism.publicationName_filter&amp;query=&amp;fq=prism.publicationName_filter%3Aevidence%5C+based%5C+preclinical%5C+medicine%5C%7C%5C%7C%5C%7CEvidence%5C+based%5C+preclinical%5C+medicine"><img class="pub-cover" src="/themes/Mirage/images/recentlyIntegrated-EBPM.PNG" alt="Evidence&ndash;Based Preclinical Medicine" /></a>
                    </div>
                </div>
            </div>
            <!-- START STATISTICS -->
