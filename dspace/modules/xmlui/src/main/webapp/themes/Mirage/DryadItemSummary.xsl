...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
            ...
            <xsl:otherwise>
                ...
                <div class="publication-header">
                    ...
                    <xsl:call-template name="publication-header">
                        ...
                        <xsl:with-param name="my_doi" select="$my_doi"/>
                        <xsl:with-param name="authorstring" select="$meta[@element='authors'][@qualifier='item']"/>
                        <xsl:with-param name="date" select=".//dim:field[@element='date' and @qualifier='accessioned']"/>
                    </xsl:call-template>
                </div>
    ...
    <xsl:template name="publication-header">
        <xsl:param name="title"/>
        <xsl:param name="my_doi" select="''"/>
        ...
        <xsl:if test="$date != ''">
            <p>
                ...
                <xsl:call-template name="format-date">
                    <xsl:with-param name="datetime"><xsl:value-of select="$date"/></xsl:with-param>
                </xsl:call-template>
            </p>
        </xsl:if>
        <xsl:if test="$my_doi != ''">
