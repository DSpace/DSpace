            ...
            <xsl:when test="current()[@rend='hasPart']">
                ...
                <div class="file-list">
                    ...
                    <p class="license-badges" style="font-size: 0.9em;">
                        ...
                        <xsl:text> </xsl:text>
                        <a href="https://creativecommons.org/publicdomain/zero/1.0/" target="_blank" class="single-image-link"><img src="/themes/Dryad/images/cc-zero.png" alt="CC0 (opens a new window)"/></a>
