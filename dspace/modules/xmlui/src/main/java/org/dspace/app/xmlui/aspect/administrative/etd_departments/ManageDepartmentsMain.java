...
/**
 * Manage groups page is the entry point for group management. From here the
 * user may browse/search a the list of groups, they may also add new groups or
 * select exiting groups to edit or delete.
 *
...
public class ManageDepartmentsMain extends AbstractDSpaceTransformer
{
    ...
    public void addBody(Body body) throws WingException, SQLException
    {
        ...
        for (Group group : groups)
        {
            ...
            row.addCell().addXref(
                    baseURL + "&submit_edit&groupID=" + group.getID(),
                    group.getName());
