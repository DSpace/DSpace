 ...
 */
public class RevisarForm extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
    /** Language Strings */
    private static final Message T_title =
        message("xmlui.ArtifactBrowser.RevisarForm.title");
    
    private static final Message T_dspace_home =
        message("xmlui.general.dspace_home");
    
    private static final Message T_trail =
        message("xmlui.ArtifactBrowser.RevisarForm.trail");
    
    private static final Message T_head = 
        message("xmlui.ArtifactBrowser.RevisarForm.head");
    
    private static final Message T_para1 =
        message("xmlui.ArtifactBrowser.RevisarForm.para1");
    
    private static final Message T_email =
        message("xmlui.ArtifactBrowser.RevisarForm.email");

    private static final Message T_email_help =
        message("xmlui.ArtifactBrowser.RevisarForm.email_help");
    
    private static final Message T_submit =
        message("xmlui.ArtifactBrowser.RevisarForm.submit");
	...
	String handle = parameters.getParameter("handle","");
        ...
        Division feedback = body.addInteractiveDivision("revisar-form",
                contextPath+"/revisionRequest/"+handle,Division.METHOD_POST,"primary");
