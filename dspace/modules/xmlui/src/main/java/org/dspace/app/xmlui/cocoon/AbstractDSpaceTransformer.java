        ...
        implements DSpaceTransformer
{
    ...
    // Only access this through getObjectManager, so that we don't have to
    // create one if we don't want to.
    ...
    protected void handleException(Exception e) throws SAXException
    {
        throw new SAXException(
                "An error was encountered while processing the '"
                        + this.getComponentName() + "' Wing based component: "
     ...
     * parameters.
     * 
     * Example Map<String,String> parameters = new Map<String,String>();
     * parameters.put("arg1","value1"); parameters.put("arg2","value2");
     * parameters.put("arg3","value3"); String url =
     * genrateURL("/my/url",parameters);
     * 
     * would result in the string: url ==
     * "/my/url?arg1=value1&arg2=value2&arg3=value3"
     * 
     * @param baseURL
     *            The baseURL without any parameters.
     * @param parameters
     *            The parameters to be encoded on in the URL.
