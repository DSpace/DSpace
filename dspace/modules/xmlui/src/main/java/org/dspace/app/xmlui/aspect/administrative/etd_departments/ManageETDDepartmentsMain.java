...
public class ManageETDDepartmentsMain extends AbstractDSpaceTransformer
{
    ...
    private static final Message T_search_column4 = message("xmlui.administrative.etd_departments.ManageETDDepartmentsMain.search_column4");

    private static final Message T_search_column5 = message("xmlui.administrative.etd_departments.ManageETDDepartmentsMain.search_column5");

    private static final Message T_collection_link = message("xmlui.administrative.etd_departments.ManageETDDepartmentsMain.collection_link");
