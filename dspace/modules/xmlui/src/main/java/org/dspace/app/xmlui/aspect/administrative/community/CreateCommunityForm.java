...
public class CreateCommunityForm extends AbstractDSpaceTransformer
{
            ...
            AuthorizeException
    {
        ...
        // DIVISION: main
        Division main = body.addInteractiveDivision("create-community",
                contextPath + "/admin/community", Division.METHOD_MULTIPART,
                "primary administrative community");
        /*
         * Whether the parent community is null is what determines if we are
         * creating a top-level community or a sub-community
         */
        if (parentCommunity != null)
        {
            main.setHead(T_main_head_sub.parameterize(parentCommunity
                    .getMetadata("name")));
        }
        else
        {
