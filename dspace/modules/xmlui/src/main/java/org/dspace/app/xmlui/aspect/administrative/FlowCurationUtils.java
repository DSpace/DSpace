...
//                " was completed with the status: " + status + ". Result: " + ((result != null) ? result : "Nothing to do for this DSpace object.")));
        flowResult.setOutcome(true);
        flowResult.setMessage(new Message("default","Result: " + ((result != null) ? result : "Nothing to do for this DSpace object.")));
