...
public abstract class AbstractFiltersTransformer extends AbstractDSpaceTransformer {
    ...
    public abstract void performSearch(DSpaceObject object) throws SQLException,  SearchServiceException, UIException;
    ...
    protected SolrQuery prepareDefaultFilters(String scope, String ...filterQueries) throws SQLException {
     ...
     */
    protected String retrieveParameters(Request request) {
    ...
    public void addViewMoreUrl(List facet, DSpaceObject dso, Request request, String fieldName) throws WingException {
