...
/**
 * Transformer que genera elementos meta con los elementos a mostrar en el listado de comunidades
 *
 * @author Nestor Oviedo
 */
public class GenerateCommunityLinksPageMeta  extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
