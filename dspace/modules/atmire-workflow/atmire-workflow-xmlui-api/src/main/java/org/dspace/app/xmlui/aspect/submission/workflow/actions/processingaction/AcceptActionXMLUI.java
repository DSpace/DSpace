 ...
 */
public class AcceptActionXMLUI extends AbstractXMLUIAction {

    private static final Message T_HEAD = message("xmlui.Submission.workflow.AcceptActionXMLUI.head");

    /** Main page messages **/
    protected static final Message T_info1=
        message("xmlui.Submission.workflow.AcceptActionXMLUI.info1");
    ...
    protected static final Message T_approve_help =
        message("xmlui.Submission.workflow.AcceptActionXMLUI.approve_help");
    protected static final Message T_approve_submit =
        message("xmlui.Submission.workflow.AcceptActionXMLUI.approve_submit");
    protected static final Message T_reject_help =
        message("xmlui.Submission.workflow.AcceptActionXMLUI.reject_help");
    protected static final Message T_reject_submit =
        message("xmlui.Submission.workflow.AcceptActionXMLUI.reject_submit");
