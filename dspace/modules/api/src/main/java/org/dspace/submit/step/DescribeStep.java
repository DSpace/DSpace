...
public class DescribeStep extends AbstractProcessingStep {
     ...
     * log4j logger
     */
    protected static Logger log = Logger.getLogger(DescribeStep.class);
   ...
   public DescribeStep() {
       ...
       try {
           ...
           throw new RuntimeException("Could not load DCInputsReader", e);
       }
   }
    ...
    public int doProcessing(Context context, HttpServletRequest request, HttpServletResponse response, SubmissionInfo subInfo) throws ServletException, IOException, SQLException, AuthorizeException {
        ...
        EventLogger.log(context, "submission-describe-step", "button_pressed=" + buttonPressed);
    ...
    protected void removeBitstream(Context context, Item item, int bitId) throws SQLException, AuthorizeException, IOException {
    ...
    protected void removeAllBitstreams(Context context, Item item) throws SQLException, AuthorizeException, IOException {
...
//                    }
    ...
    protected int processExternalUrl(HttpServletRequest request, SubmissionInfo subInfo) throws AuthorizeException, IOException, SQLException {
