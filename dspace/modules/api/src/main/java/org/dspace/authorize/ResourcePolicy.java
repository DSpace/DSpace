...
public class ResourcePolicy
{
    ...
    public void delete() throws SQLException
    {
        ...
        // Remove ourself
        if(getResourceType() == Constants.ITEM){
            //Fire an item modified event so that our discovery index stays up to date
            myContext.addEvent(new Event(Event.MODIFY, Constants.ITEM, getResourceID(), null));
        }
    ...
    public void setResource(DSpaceObject o)
    {
        ...
        if(o.getType() == Constants.ITEM){
            //Fire an item modified event so that our discovery index stays up to date
            myContext.addEvent(new Event(Event.MODIFY, Constants.ITEM, o.getID(), null));
        }
    }
