...
public class Bundle extends DSpaceObject
{
    ...
    public Collection getOwningCollection(Item item)
    {
        try{
            if(item.getOwningCollection()!=null)
            {
                ...
                WorkspaceItem workspaceItem = WorkspaceItem.findByItem(ourContext,item);
                ...
                {
                    WorkflowItem workflowItem = WorkflowItem.findByItemId(ourContext,item.getID());
    ...
    public DSpaceObject getAdminObject(int action) throws SQLException
    {
        ...
        {
            item = items[0];
            collection = getOwningCollection(item);
            if (collection != null)
            {
