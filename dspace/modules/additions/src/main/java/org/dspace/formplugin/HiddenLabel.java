...
public class HiddenLabel extends DSpaceControlledVocabulary {

    private static Logger log = org.apache.logging.log4j.LogManager.getLogger(HiddenLabel.class);
