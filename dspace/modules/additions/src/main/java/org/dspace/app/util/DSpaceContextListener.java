...
/*Damanzano: Se agrega para habilitar citación*/
...
public class DSpaceContextListener implements ServletContextListener
{
    ...
    public void contextInitialized(ServletContextEvent event)
    {
        ...
        /*Damanzano: se usa para habilitar citaciones*/
        /**
         * Stage 3 - This stage is added for citation generation
         *
         * Load the citation configuration if exists
         *
         */
        if (ConfigurationManager.isConfigured()) {
            String citationConfig = null;
            try {

                citationConfig = ConfigurationManager.getProperty("citation", "config.dir");
