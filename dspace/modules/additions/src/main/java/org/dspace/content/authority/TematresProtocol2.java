 ...
 *
 */
public abstract class TematresProtocol2 implements ChoiceAuthority
{
    private static Logger log = Logger.getLogger(TematresProtocol2.class);

    // contact URL from configuration
    private static String url = null;

    public TematresProtocol2()
    {
        if (url == null)
        {
            url = ConfigurationManager.getProperty("tematres2.url");
