...
public class ItemBibliographyFormatsTag extends TagSupport{
    ...
    public String itemButtonsMarkup(HttpServletRequest request, Item item){
        ...
        String mendeleyLink= "<button class=\"col-md-12 col-sm-12 col-xs-12 btn btn-default\" onclick=\"MendeleyImporterApi.open()\"><img src=\"" +request.getContextPath()+ "/image/registered.png"+"\" style=\"padding:3px;\"/>Mendeley</button>";
        String endNoteLink = "<a class=\"col-md-12 col-sm-12 col-xs-12 btn btn-default\" href=\"" + request.getContextPath() + "/bibliography?bib=en&handle_item=" + item.getHandle() + "\" target=\"_blank\" alt=\"Download EndNote record\" id=\"en\"><img src=\"" +request.getContextPath()+ "/image/registered.png"+"\" style=\"padding:3px;\"/>EndNote</a>";
