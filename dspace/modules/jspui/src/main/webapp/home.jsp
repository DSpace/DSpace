...
<dspace:layout locbar="nolink" titlekey="jsp.home.title" feedData="<%= feedData %>" style="default">
    ...
    <p>To get started, review our short <a href="<%= request.getContextPath() %>/help/about_submitting.jsp">guide to submitting your research</a>.</p>
    ...
    <a href="<%= request.getContextPath() %>/mydspace"><button class="btn btn-primary">Submit</button></a> 
