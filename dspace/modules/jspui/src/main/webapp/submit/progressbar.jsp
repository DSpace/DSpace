...
<%    
    ...
    %>
                <a href="#" class="btn btn-primary"><input class="submitProgressButtonCurrent" style="background-image: inherit; background-color: inherit; border-style: none;" disabled="disabled" type="submit" name="<%=AbstractProcessingStep.PROGRESS_BAR_PREFIX + stepAndPage%>" value="1<%=heading%>" />
    <%
             }
        	 else
        	 {
    ...
    %>
               <a href="#" class="btn btn-success"><input class="submitProgressButtonDone" style="background-image: inherit; background-color: inherit; border-style: none;" disabled="disabled" type="submit" name="<%=AbstractProcessingStep.PROGRESS_BAR_PREFIX + stepAndPage%>" value="2<%=heading%>" /></a>
    <%
        	 }
           }
           ...
           {
	         %>
		            <a href="#" class="btn btn-primary"><input class="submitProgressButtonCurrent" style="background-image: inherit; background-color: inherit; border-style: none; color: #FFF;" disabled="disabled" type="submit" name="<%=AbstractProcessingStep.PROGRESS_BAR_PREFIX + stepAndPage%>" value="<%=heading%>" /></a>
        	 <%
           }
		   else if(workflowMode) //if in workflow mode, can jump to any step/page
    	   {
		     %>
            <a href="#" class="btn btn-success"><input class="submitProgressButtonDone" style="background-image: inherit; background-color: inherit; border-style: none;" type="submit" name="<%=AbstractProcessingStep.PROGRESS_BAR_PREFIX + stepAndPage%>" value="4<%=heading%>" /></a>
              <!--<input class="submitProgressButtonDone btn btn-success" type="submit" name="<%=AbstractProcessingStep.PROGRESS_BAR_PREFIX + stepAndPage%>" value="4<%=heading%>" />-->
			 <%
    	   }
    	  ...
    	  {
%>
            <a href="#" class="btn btn-info"><input class="submitProgressButtonDone" style="background-image: inherit; background-color: inherit; border-style: none;" type="submit" name="<%=AbstractProcessingStep.PROGRESS_BAR_PREFIX + stepAndPage%>" value="5<%=heading%>" /></a>
              <!--<input class="submitProgressButtonDone btn btn-info" type="submit" name="<%=AbstractProcessingStep.PROGRESS_BAR_PREFIX + stepAndPage%>" value="5<%=heading%>" />-->
<%
          }
...
%>
		    <a href="#" class="btn btn-success"><input class="submitProgressButtonNotDone" style="background-image: inherit; background-color: inherit; border-style: none; color: #FFF;" disabled="disabled" type="submit" name="<%=AbstractProcessingStep.PROGRESS_BAR_PREFIX + stepAndPage%>" value="<%=heading%>" /></a>
        <!--<input class="submitProgressButtonNotDone btn btn-default" disabled="disabled" type="submit" name="<%=AbstractProcessingStep.PROGRESS_BAR_PREFIX + stepAndPage%>" value="6<%=heading%>" />-->
