        ...
        <div class="item-summary-view-metadata">
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <xsl:call-template name="itemSummaryView-DIM-reputacion"/>
                    <xsl:call-template name="itemSummaryView-DIM-itemRelated"/>        
                    <xsl:call-template name="itemSummaryView-DIM-revisionRelated"/>        
                    <xsl:call-template name="itemSummaryView-DIM-juicioRelated"/> 
...
<xsl:template name="itemSummaryView-DIM-reputacion">
    ...
    <xsl:template name="itemSummaryView-DIM-revisionRelated">
        <xsl:if test="dim:field[@element='relation' and @qualifier='isrelatedtoRevision']">
            <div class="simple-item-view-isrelatedtoRevision word-break item-page-field-wrapper table">
                <h5 class="item-headers">
    ...
    <xsl:template name="itemSummaryView-DIM-itemRelated">
        <xsl:if test="dim:field[@element='relation' and @qualifier='isrelatedtoItem']">
            <div class="simple-item-view-isrelatedtoItem word-break item-page-field-wrapper table">
                <h5 class="item-headers">
    ...
    <xsl:template name="itemSummaryView-DIM-juicioRelated">
        <xsl:if test="dim:field[@element='relation' and @qualifier='isrelatedtoJuicio']">
            <div class="simple-item-view-isrelatedtoJuicio word-break item-page-field-wrapper table">
                <h5 class="item-headers">
