...
public class CommunityGroupCommunityLinkRepository extends AbstractDSpaceRestRepository
    ...
    public Page<CommunityRest> getCommunities(@Nullable HttpServletRequest request,
        ...
        try {
            ...
            CommunityGroup communityGroup = cgs.find(communityGroupId);
            if (communityGroup != null) {
                communities = cgs.getCommunities(context, communityGroup);
            }
            return converter.toRestPage(communities, null, utils.obtainProjection());
