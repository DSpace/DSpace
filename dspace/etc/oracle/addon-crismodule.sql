...
-- DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST.
-- DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST.
create table cris_do (id number(10,0) not null, crisID varchar2(255 char) unique, sourceID varchar2(255 char) unique, sourceRef varchar2(255 char), status number(1,0), uuid varchar2(255 char) not null unique, timestampCreated timestamp, timestampLastModified timestamp, typo_id number(10,0), primary key (id));
...
create table cris_do_no (id number(10,0) not null, endDate timestamp, startDate timestamp, positionDef number(10,0), status number(1,0), timestampCreated timestamp, timestampLastModified timestamp, uuid varchar2(255 char) not null unique, scopeDef_id number(10,0), parent_id number(10,0), typo_id number(10,0), primary key (id), unique (positionDef, typo_id, parent_id));
...
create table cris_orgunit (id number(10,0) not null, crisID varchar2(255 char) unique, sourceID varchar2(255 char) unique, sourceRef varchar2(255 char), status number(1,0), uuid varchar2(255 char) not null unique, timestampCreated timestamp, timestampLastModified timestamp, primary key (id));
...
create table cris_pj_no (id number(10,0) not null, endDate timestamp, startDate timestamp, positionDef number(10,0), status number(1,0), timestampCreated timestamp, timestampLastModified timestamp, uuid varchar2(255 char) not null unique, scopeDef_id number(10,0), parent_id number(10,0), typo_id number(10,0), primary key (id), unique (positionDef, typo_id, parent_id));
...
create table cris_project (id number(10,0) not null, crisID varchar2(255 char) unique, sourceID varchar2(255 char) unique, sourceRef varchar2(255 char), status number(1,0), uuid varchar2(255 char) not null unique, timestampCreated timestamp, timestampLastModified timestamp, primary key (id));
...
create table cris_rp_no (id number(10,0) not null, endDate timestamp, startDate timestamp, positionDef number(10,0), status number(1,0), timestampCreated timestamp, timestampLastModified timestamp, uuid varchar2(255 char) not null unique, scopeDef_id number(10,0), parent_id number(10,0), typo_id number(10,0), primary key (id), unique (positionDef, typo_id, parent_id));
