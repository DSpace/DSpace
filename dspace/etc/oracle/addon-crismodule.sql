...
-- DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST.
-- DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST. DUMP YOUR DATABASE FIRST.
create table cris_do (id number(10,0) not null, crisID varchar2(255 char) unique, sourceID varchar2(255 char) unique, status number(1,0), uuid varchar2(255 char) not null unique, timestampCreated timestamp, timestampLastModified timestamp, typo_id number(10,0), primary key (id));
...
create table cris_orgunit (id number(10,0) not null, crisID varchar2(255 char) unique, sourceID varchar2(255 char) unique, status number(1,0), uuid varchar2(255 char) not null unique, timestampCreated timestamp, timestampLastModified timestamp, primary key (id));
...
create table cris_project (id number(10,0) not null, crisID varchar2(255 char) unique, sourceID varchar2(255 char) unique, status number(1,0), uuid varchar2(255 char) not null unique, timestampCreated timestamp, timestampLastModified timestamp, primary key (id));
...
create table cris_rpage (id number(10,0) not null, crisID varchar2(255 char) unique, sourceID varchar2(255 char) unique, status number(1,0), uuid varchar2(255 char) not null unique, epersonID number(10,0) unique, namesTimestampLastModified timestamp, timestampCreated timestamp, timestampLastModified timestamp, primary key (id));
