...
create table jdyna_values (DTYPE varchar2(31 char) not null, id number(10,0) not null, sortValue varchar2(255 char), dateValue timestamp, textValue clob, linkdescription varchar2(255 char), linkvalue varchar2(255 char), fileextension varchar2(255 char), filefolder varchar2(255 char), filemime varchar2(255 char), filename varchar2(255 char), doubleValue double precision, rpvalue number(10,0), projectvalue number(10,0), ouvalue number(10,0), dovalue number(10,0), booleanValue number(1,0) primary key (id));
...
create table jdyna_widget_checkradio (id number(10,0) not null, option4row number(10,0), staticValues clob, query varchar2(255), primary key (id));
