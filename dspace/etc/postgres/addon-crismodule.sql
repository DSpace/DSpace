...
create table jdyna_containable (DTYPE varchar(31) not null, id int4 not null, externalJSP varchar(255), cris_rp_pdef_fk int4, cris_pj_pdef_fk int4, cris_ou_pdef_fk int4, cris_rp_no_pdef_fk int4, cris_pj_no_pdef_fk int4, cris_ou_no_pdef_fk int4, cris_rp_no_tp int4, cris_pj_no_tp int4, cris_ou_no_tp_fk int4, jdyna_no_pdef_fk int4, primary key (id));
...
create table jdyna_no_tp (id int4 not null, label varchar(255), shortName varchar(255), accessLevel int4, help varchar(4000), inline bool not null, mandatory bool not null, newline bool not null, priority int4 not null, repeatable bool not null, primary key (id));
create table jdyna_no_tp2pdef (jdyna_no_tp_id int4 not null, jdyna_no_pdef_id int4 not null);
...
alter table jdyna_containable add constraint FK504277E1C8C41239 foreign key (jdyna_no_pdef_fk) references jdyna_no_pdef;
...
alter table jdyna_no_tp2pdef add constraint FK719B7D3AC8C4128F foreign key (jdyna_no_pdef_id) references jdyna_no_pdef;
