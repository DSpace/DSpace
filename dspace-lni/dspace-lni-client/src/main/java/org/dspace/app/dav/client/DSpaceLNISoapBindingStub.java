...
public class DSpaceLNISoapBindingStub extends org.apache.axis.client.Stub implements org.dspace.app.dav.client.LNISoapServlet {
    ...
    private static void initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "keepProperties"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"), boolean.class, false, false);
        oper.addParameter(param);
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://dspace.org/xmlns/lni", "fault"),
                      "org.dspace.app.dav.client.LNIRemoteException",
                      new javax.xml.namespace.QName("http://dspace.org/xmlns/lni", "LNIRemoteException"), 
                      true
                     ));
        _operations[0] = oper;
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("lookup");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "handle"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "bitstreamPid"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "lookupReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://dspace.org/xmlns/lni", "fault"),
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "doc"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "depth"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "propfindReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://dspace.org/xmlns/lni", "fault"),
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "proppatchReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://dspace.org/xmlns/lni", "fault"),
    ...
    public DSpaceLNISoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public DSpaceLNISoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public DSpaceLNISoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public int copy(java.lang.String source, java.lang.String destination, int depth, boolean overwrite, boolean keepProperties) throws java.rmi.RemoteException, org.dspace.app.dav.client.LNIRemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://dspace.org/xmlns/lni", "copy"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {source, destination, java.lang.Integer.valueOf(depth), java.lang.Boolean.valueOf(overwrite), java.lang.Boolean.valueOf(keepProperties)});
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof org.dspace.app.dav.client.LNIRemoteException) {
              throw (org.dspace.app.dav.client.LNIRemoteException) axisFaultException.detail;
         }
   }
  throw axisFaultException;
    ...
    public java.lang.String lookup(java.lang.String handle, java.lang.String bitstreamPid) throws java.rmi.RemoteException, org.dspace.app.dav.client.LNIRemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://dspace.org/xmlns/lni", "lookup"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {handle, bitstreamPid});
  ...
  throw axisFaultException;
    ...
    public java.lang.String propfind(java.lang.String uri, java.lang.String doc, int depth, java.lang.String types) throws java.rmi.RemoteException, org.dspace.app.dav.client.LNIRemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://dspace.org/xmlns/lni", "propfind"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {uri, doc, java.lang.Integer.valueOf(depth), types});
  ...
  throw axisFaultException;
    ...
    public java.lang.String proppatch(java.lang.String uri, java.lang.String doc) throws java.rmi.RemoteException, org.dspace.app.dav.client.LNIRemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://dspace.org/xmlns/lni", "proppatch"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {uri, doc});
