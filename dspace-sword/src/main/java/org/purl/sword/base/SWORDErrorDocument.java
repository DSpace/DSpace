            ...
            if (errorURI.startsWith("http://purl.org/net/sword/error/")) {
                ...
                if (!(errorURI.equals(ErrorCodes.ERROR_CONTENT) ||
                    ...
                    info.addValidationInfo(new SwordValidationInfo(xmlName,
                                                                   ATTRIBUTE_HREF_NAME,
                                                                   "Errors in the SWORD namespace are reserved and " +
                                                                       "legal values are enumerated in the SWORD 1.3 " +
                                                                       "specification. Implementations MAY define " +
                                                                       "their own errors, but MUST use a different " +
                                                                       "namespace to do so.",
