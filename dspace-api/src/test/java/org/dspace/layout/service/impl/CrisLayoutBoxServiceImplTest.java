...
public class CrisLayoutBoxServiceImplTest {
    ...
    @Mock
    private EntityTypeService ets;

    @Before
    public void setUp() throws Exception {
        crisLayoutBoxService = new CrisLayoutBoxServiceImpl(dao, itemService, authorizeService, ets);
    }

    @Test
    public void nullItemReturnsEmptyList() throws Exception {
        ...
        when(dao.findByEntityType(any(Context.class), eq(""), eq(tabId), any(), any()))
