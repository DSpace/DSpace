...
public class ShibAuthenticationTest extends AbstractUnitTest {
    ...
    public void setup() {
        ...
        when(configurationService.getBooleanProperty("authentication-shibboleth.eperson.metadata.autocreate", true)).thenReturn(true);
    ...
    public void testPhoneMetadataUpdateOrder() throws Exception {
        ...
        assertTrue("metadataHeaderMap should contain SHIB-telephone", shibAuthentication.metadataHeaderMap.containsKey("SHIB-telephone"));
    ...
    public void testInitializeLoadsMultipleMappings() throws Exception {
        ...
        assertNotNull("metadataHeaderMap should be initialized", shibAuthentication.metadataHeaderMap);
        assertTrue("metadataHeaderMap should contain SHIB-telephone", shibAuthentication.metadataHeaderMap.containsKey("SHIB-telephone"));
        assertTrue("metadataHeaderMap should contain SHIB-dept", shibAuthentication.metadataHeaderMap.containsKey("SHIB-dept"));
    }
