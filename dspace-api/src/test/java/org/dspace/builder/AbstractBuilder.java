...
public abstract class AbstractBuilder<T, S> {
    ...
    static DynamicLayoutTabService dynamicLayoutTabService;
    static DynamicLayoutBoxService dynamicLayoutBoxService;
    static DynamicLayoutFieldService dynamicLayoutFieldService;
    static DynamicLayoutMetadataGroupService dynamicLayoutMetadataGroupService;
    ...
    public static void init() {
        ...
        dynamicLayoutTabService = DynamicLayoutServiceFactory.getInstance().getTabService();
        dynamicLayoutBoxService = DynamicLayoutServiceFactory.getInstance().getBoxService();
        dynamicLayoutFieldService = DynamicLayoutServiceFactory.getInstance().getFieldService();
        dynamicLayoutMetadataGroupService = DynamicLayoutServiceFactory.getInstance().getMetadataGroupService();
    ...
    public static void destroy() {
        ...
        processService = null;
        dynamicLayoutTabService = null;
        dynamicLayoutBoxService = null;
        dynamicLayoutFieldService = null;
        dynamicLayoutMetadataGroupService = null;
