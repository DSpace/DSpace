 ...
 *
 */
public class OpenPolicyFinderDataProviderTest extends AbstractDSpaceTest {

    ExternalDataService externalDataService;
    ExternalDataProvider opfJournalProvider;
    ExternalDataProvider opfPublisherProvider;
    ...
    public void setUp() {
        ...
        opfJournalProvider = externalDataService.getExternalDataProvider("opfJournal");
        opfPublisherProvider = externalDataService.getExternalDataProvider("opfPublisher");
        opfJournalIssnProvider =
         externalDataService.getExternalDataProvider("opfJournalIssn");
    }
    ...
    /**
     * Test searching the OpenPolicyFinderJournalISSNDataProvider for an ISSN and inspect the returned data object
     * The provider is configured to use the Mock OpenPolicyFinderService.
     */
    @Test
    public void testGetJournalISSNExternalObject() {
        ...
        Optional<ExternalDataObject> externalDataObject = opfJournalIssnProvider.getExternalDataObject(validIssn);
    ...
    public void testSearchJournalISSNExternalObjects() {
        ...
        List<ExternalDataObject> externalDataObjects =
            opfJournalIssnProvider.searchExternalDataObjects(validIssn, 0, 1);
    ...
    /**
     * Test searching the OpenPolicyFinderJournalDataProvider for a journal and inspect the returned data object
     * The provider is configured to use the Mock OpenPolicyFinderService.
     */
    @Test
    public void testGetJournalExternalObject() {
        ...
        String validIssn = "0140-6736";
        String validName = "The Lancet";
        Optional<ExternalDataObject> externalDataObject = opfJournalProvider.getExternalDataObject(validName);
        // If data object isn't here, throw a resource not found exception
        ExternalDataObject dataObject = externalDataObject.orElseThrow(
    ...
    public void testSearchJournalObjects() {
        ...
        String validName = "The Lancet";
        List<ExternalDataObject> externalDataObjects =
            opfJournalProvider.searchExternalDataObjects(validName, 0, 1);
    ...
    public void testGetPublisherExternalObject() {
        ...
        // dc.identifier.opfPublisher    112
        ...
        Optional<ExternalDataObject> externalDataObject = opfPublisherProvider.getExternalDataObject(validName);
        // If data object isn't here, throw a resource not found exception
        ExternalDataObject dataObject = externalDataObject.orElseThrow(
            () -> new ResourceNotFoundException("Couldn't find a data object for publication name " + validName));
        ...
        for (MetadataValueDTO metadataValue : dataObject.getMetadata()) {
            if (TITLE_FIELD.matches(metadataValue)) {
                title = metadataValue.getValue();
            } else if (OPF_PUBLISHER_FIELD.matches(metadataValue)) {
                identifier = metadataValue.getValue();
        ...
        // Does dc.identifier.opfPublisher match the expected value?
    ...
    public void testSearchPublisherExternalObjects() {
        ...
        // Retrieve the dataobject(s) from the data provider
        List<ExternalDataObject> externalDataObjects =
            opfPublisherProvider.searchExternalDataObjects(validName, 0, 1);
    ...
    public void testComparePublisherExternalObjects() {
        ...
        exemplarDataObject.setSource("opfPublisher");
        ...
        exemplarDataObject.addMetadata(OPF_PUBLISHER_FIELD.toMetadata(validIdentifier));
        ...
        exemplarDataObject2.setSource("opfPublisher");
        ...
        exemplarDataObject2.addMetadata(OPF_PUBLISHER_FIELD.toMetadata(validIdentifier));

        // Nonequal object should NOT evaluate as equal to our data
        ExternalDataObject nonEqualObject = new ExternalDataObject();
        nonEqualObject.setSource("opfPublisher");
        ...
        nonEqualObject.addMetadata(OPF_PUBLISHER_FIELD.toMetadata(validIdentifier));
