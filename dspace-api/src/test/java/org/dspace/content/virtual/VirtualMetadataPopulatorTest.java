...
public class VirtualMetadataPopulatorTest {
    ...
    public void testIsUseForPlaceTrueForRelationshipType() {
        ...
        assertEquals(false, virtualMetadataPopulator.isUseForPlaceTrueForRelationshipType(relationshipType, false),
            "TestGetFields 0");
        // Assert that the useForPlace for our mocked relationshipType is true
        assertEquals(true, virtualMetadataPopulator.isUseForPlaceTrueForRelationshipType(relationshipType, true),
            "TestGetFields 1");
    }
}
