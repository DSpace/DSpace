...
public class RelatedTest {
    ...
    public void testGetVirtualMetadataConfiguration() {
        ...
        assertEquals(virtualMetadataConfiguration.getClass(), related.getVirtualMetadataConfiguration().getClass(),
    ...
    public void testSetVirtualMetadataConfiguration() {
        ...
        // The class reported should match our defined virtualMetadataConfiguration.getClass()
        assertEquals(virtualMetadataConfiguration, related.getVirtualMetadataConfiguration(),
            "TestGetVirtualMetadataConfiguration 0");
    }
    ...
    public void testGetValues() throws Exception {
        ...
        assertEquals(virtualMetadataConfiguration.getValues(context, item), related.getValues(context, item),
            "TestGetValues 0");
        related.setPlace(1);
