...
public class EntityServiceImplTest {
    ...
    public void testfindByItemId() throws Exception {
        ...
        assertEquals("ItemName", entityService.findByItemId(context, item.getID()).getItem().getName(),
            "TestFindByItem 0");
    }
    ...
    public void testGetRelationsByTypeName() throws Exception {
        ...
        assertEquals(relationshipList, entityService.getRelationsByTypeName(context, "leftwardType"),
    ...
    public void testGetAllRelationshipTypes() throws Exception {
        ...
        assertEquals(relationshipTypeList, entityService.getAllRelationshipTypes(context, entity),
    ...
    public void testGetLeftRelationshipTypes() throws Exception {
        ...
        assertEquals(relationshipTypeList, entityService.getLeftRelationshipTypes(context, entity),
    ...
    public void testGetRightRelationshipTypes() throws Exception {
        ...
        assertEquals(relationshipTypeList, entityService.getRightRelationshipTypes(context, entity),
    ...
    public void testGetRelationshipTypesByTypeName() throws Exception {
        ...
        assertEquals(list, entityService.getRelationshipTypesByTypeName(context, "leftwardType"),
