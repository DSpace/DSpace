...
extends AbstractIntegrationTest
{
    ...
    protected HashMap<ROLE,Group> roleGroups = new HashMap<ROLE, Group>();
    protected HashMap<ROLE,EPerson> roleEPersons = new HashMap<ROLE, EPerson>();
            ...
            throws SQLException, AuthorizeException, IOException
    {
        ...
        if (expectAuthFail) {
            try {
                ...
                //handle exception triggered by database rule
            }
            ...
            Assert.assertThat(state, not(equalTo(wfi.getState())));
