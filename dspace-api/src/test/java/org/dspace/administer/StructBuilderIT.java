    ...
    public void testImportStructure()
        ...
        try (InputStream input = new ByteArrayInputStream(inputBytes);) {
            StructBuilder.importStructure(context, input, outputDocument);
                ...
                | AuthorizeException | SAXException ex) {
...
//                .withNodeFilter(new MyNodeFilter())
    ...
    public void testExportStructure()
        ...
        context.turnOffAuthorisationSystem();
        Community community0 = Community.create(null, context);
        community0.addMetadata(MetadataSchema.DC_SCHEMA, "title", null,
                null, "Top Community 0");
        Collection collection0_0 = community0.createCollection();
        collection0_0.addMetadata(MetadataSchema.DC_SCHEMA, "title", null,
                null, "Collection 0.0");
...
//                .withNodeFilter(new MyNodeFilter())
     ...
     *
     * @param community the Community to be pruned of all descendants.
     * @throws SQLException passed through.
     * @throws AuthorizeException passed through.
     * @throws IOException passed through.
     */
    private void deleteSubCommunities(Community community)
