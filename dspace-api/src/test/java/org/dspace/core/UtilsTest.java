...
public class UtilsTest extends AbstractUnitTest {
    ...
    public void testGetBaseUrl() {
        assertEquals("http://dspace.org", Utils.getBaseUrl("http://dspace.org/server"),
                     "Test remove /server");

        assertEquals("https://dspace.org", Utils.getBaseUrl("https://dspace.org/server/api/core/items"),
                     "Test remove /server/api/core/items");

        assertEquals("https://dspace.org", Utils.getBaseUrl("https://dspace.org/"),
                     "Test remove trailing slash");

        assertEquals("https://demo.dspace.org", Utils.getBaseUrl("https://demo.dspace.org"),
                     "Test keep url");

        assertEquals("http://localhost:8080", Utils.getBaseUrl("http://localhost:8080"),
                     "Test keep url");

        assertEquals("http://localhost:8080", Utils.getBaseUrl("http://localhost:8080/server"),
                     "Test keep url");
    ...
    public void testGetHostName() {
        assertEquals("dspace.org", Utils.getHostName("http://dspace.org"),
                     "Test remove HTTP");

        assertEquals("dspace.org", Utils.getHostName("https://dspace.org"),
                     "Test remove HTTPS");

        assertEquals("dspace.org", Utils.getHostName("https://dspace.org/"),
                     "Test remove trailing slash");

        assertEquals("dspace.org", Utils.getHostName("https://www.dspace.org"),
                     "Test remove www.");

        assertEquals("demo.dspace.org", Utils.getHostName("https://demo.dspace.org"),
                     "Test keep other prefixes");

        assertEquals("demo.dspace.org", Utils.getHostName("https://demo.dspace.org/search?query=test"),
                     "Test with parameter");
        ...
        assertEquals("demo.dspace.org",
                     ...
                     "Test with parameter with encoded space");
    ...
    public void testInterpolateConfigsInString() {
        ...
        assertEquals(expectedValue, Utils.interpolateConfigsInString(stringWithVariable),
