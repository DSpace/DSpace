...
import org.dspace.content.DSpaceShareItem;
...
public class ShareItemWrapper implements ShareItem {
	...
	private DSpaceShareItem item;
	 
	
	public ShareItemWrapper (DSpaceShareItem i) {
		item = (DSpaceShareItem) i;
	}
	
	private String getMetadata (String md) {
		Metadatum[] values = this.item.getShareMetadata(md);
