...
public class Text {
    ...
    @XmlElements( {
        ...
        @XmlElement(name = "front", required = true, type = Front.class),
        @XmlElement(name = "body", required = true, type = Body.class),
        @XmlElement(name = "back", required = true, type = Back.class)
    })
