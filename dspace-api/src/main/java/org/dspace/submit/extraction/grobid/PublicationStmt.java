 ...
 *           &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.publicationStmtPart.agency"/&gt;
 *           &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.publicationStmtPart.detail" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlType(name = "", propOrder = {
    "psAndTrashes",
    "publishersAndAddressesAndDates"
})
...
public class PublicationStmt {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "pubPlace", type = PubPlace.class),
        @XmlElement(name = "idno", type = Idno.class),
        @XmlElement(name = "availability", type = Availability.class)
    })
    protected List<Object> publishersAndAddressesAndDates;
    ...
    /**
     * Gets the value of the publishersAndAddressesAndDates property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the publishersAndAddressesAndDates property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPublishersAndAddressesAndDates().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPublishersAndAddressesAndDates() {
        if (publishersAndAddressesAndDates == null) {
            publishersAndAddressesAndDates = new ArrayList<Object>();
        }
        return this.publishersAndAddressesAndDates;
    }
