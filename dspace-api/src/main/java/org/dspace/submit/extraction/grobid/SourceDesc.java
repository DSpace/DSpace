...
public class SourceDesc {
    ...
    protected java.util.List<Object> biblsAndBiblStructsAndListBibls;
    @XmlElements( {
        @XmlElement(name = "p", type = P.class),
        @XmlElement(name = "trash", type = Trash.class)
    })
    protected java.util.List<Object> psAndTrashes;
     ...
     * {@link Table }
     */
    public java.util.List<Object> getBiblsAndBiblStructsAndListBibls() {
        if (biblsAndBiblStructsAndListBibls == null) {
            biblsAndBiblStructsAndListBibls = new ArrayList<Object>();
        }
     ...
     * {@link Trash }
     */
    public java.util.List<Object> getPSAndTrashes() {
