 ...
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}classCode"/&gt;
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}keywords"/&gt;
 *       &lt;/choice&gt;
...
@XmlType(name = "", propOrder = {
    "classCodesAndKeywords"
})
@XmlRootElement(name = "textClass")
public class TextClass {

    @XmlElements( {
        @XmlElement(name = "classCode", type = ClassCode.class),
        @XmlElement(name = "keywords", type = Keywords.class)
    })
    protected List<Object> classCodesAndKeywords;
    ...
    /**
     * Gets the value of the classCodesAndKeywords property.
     *
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the classCodesAndKeywords property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getClassCodesAndKeywords().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     * {@link Keywords }
     */
    public List<Object> getClassCodesAndKeywords() {
        if (classCodesAndKeywords == null) {
            classCodesAndKeywords = new ArrayList<Object>();
        }
        return this.classCodesAndKeywords;
    }
