...
public class Bibl {
    ...
    @XmlElementRefs( {
        ...
        @XmlElementRef(name = "author", namespace = "http://www.tei-c.org/ns/1.0", type = Author.class, required =
            false),
        @XmlElementRef(name = "editor", namespace = "http://www.tei-c.org/ns/1.0", type = Editor.class, required =
            false),
        @XmlElementRef(name = "meeting", namespace = "http://www.tei-c.org/ns/1.0", type = Meeting.class, required =
            false),
        @XmlElementRef(name = "publisher", namespace = "http://www.tei-c.org/ns/1.0", type = Publisher.class,
            required = false),
        @XmlElementRef(name = "biblScope", namespace = "http://www.tei-c.org/ns/1.0", type = BiblScope.class,
            required = false),
        @XmlElementRef(name = "pubPlace", namespace = "http://www.tei-c.org/ns/1.0", type = PubPlace.class, required
            = false),
        @XmlElementRef(name = "series", namespace = "http://www.tei-c.org/ns/1.0", type = Series.class, required =
            false),
        @XmlElementRef(name = "bibl", namespace = "http://www.tei-c.org/ns/1.0", type = Bibl.class, required = false),
        @XmlElementRef(name = "edition", namespace = "http://www.tei-c.org/ns/1.0", type = Edition.class, required =
            false),
