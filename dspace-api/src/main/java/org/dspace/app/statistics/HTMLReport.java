...
public class HTMLReport implements Report {
    ...
    public String header(String title) {
        ...
        frag.append(
            ".reportTitle { width: 100%; clear: both; text-align: center; font-weight: bold; font-size: 200%; margin:" +
                " 20px; }\n");
        frag.append(
            ".reportSection { width: 100%; clear: both; font-weight: bold; font-size: 160%; margin: 10px; text-align:" +
