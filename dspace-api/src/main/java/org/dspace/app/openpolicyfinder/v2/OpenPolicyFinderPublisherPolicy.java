...
/**
 * Plain java representation of a Open Policy Finder Publisher Policy object, based on Open Policy Finder API responses.
 *
 * In a Open Policy Finder search for deposit policies, each journal contains one or more publisher policies
 ...
 * of overall policies in UI (as per legacy Open Policy Finder data)
 *
 * @see OpenPolicyFinderJournal
 * @see OpenPolicyFinderPermittedVersion
 */
public class OpenPolicyFinderPublisherPolicy implements Serializable {

    private int id;
    private boolean openAccessPermitted;
    private String uri;
    private String internalMoniker;
    private List<OpenPolicyFinderPermittedVersion> permittedVersions;
    ...
    public List<OpenPolicyFinderPermittedVersion> getPermittedVersions() {
        return permittedVersions;
    }

    public void setPermittedVersions(List<OpenPolicyFinderPermittedVersion> permittedVersions) {
