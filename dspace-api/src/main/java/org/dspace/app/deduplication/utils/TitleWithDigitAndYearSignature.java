...
public class TitleWithDigitAndYearSignature extends MD5ValueSignature {
    ...
    public static void main(String[] args) {
        String[] testStrings = { "Title 1", "Title 2", "Title 3 with subtitle",
            "Evanescent wave spectroscopy of methylene blue solutions at surfaces using"
                    + " a continuum generated by a nonlinear fiber" };
