...
public class PluginManager
{
   ...
   /**
     ...
     */
    private static class PathsClassLoader
            extends ClassLoader
    {
         ...
         */
        private PathsClassLoader(ClassLoader parent, String[] classpath)
        {
            super(parent);
                ...
                throws ClassNotFoundException
        {
            ...
            for (String aPath : classpath)
            {
                ...
                if (pathFile.isDirectory())
                {
                    byte[] body;
                    int bodySize;
                    File bodyFile = new File(pathFile, bodyPath);
                    if (bodyFile.exists())
                        continue;
                ...
                else if (pathFile.isFile()) //  treat as jar if possible
                {
                    byte[] body;
                    int bodySize;
