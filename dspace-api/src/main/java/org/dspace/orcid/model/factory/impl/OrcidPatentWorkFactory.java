 ...
 */
public class OrcidPatentWorkFactory extends OrcidWorkFactory implements OrcidEntityFactory {

    private static final Logger LOGGER = LoggerFactory.getLogger(OrcidPatentWorkFactory.class);
    ...
    private OrcidPatentWorkFieldMapping fieldMapping;

    @Override
    public OrcidEntityType getEntityType() {
        return OrcidEntityType.PATENT;
    }
    ...
    public void setFieldMapping(OrcidPatentWorkFieldMapping fieldMapping) {
