...
/**
 * Required methods for a runnable-handler.
 */
public interface DSpaceRunnableHandler {
    ...
    /**
     * This method will perform the error logging of the message given along
     * with a stack trace.
     * @param message   The message to be logged as an error
    ...
    /**
     * This method will grab the InputStream for the file defined by the given
     * file name. The exact implementation will differ based on whether it's a
     * REST call or CommandLine call. The REST Call will look for Bitstreams in
     * the Database whereas the CommandLine call will look on the filesystem.
    ...
    /**
     * This method will write the InputStream to either a file on the filesystem
     * or a bitstream in the database depending on whether it's coming from a
     * CommandLine call or REST call respectively.
     * @param context       The relevant DSpace context
