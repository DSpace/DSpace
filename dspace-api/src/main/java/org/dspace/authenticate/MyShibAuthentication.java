 ...
 * @version $Revision$
 */
public class MyShibAuthentication implements AuthenticationMethod {
    /**
     * log4j category
     */
    private static Logger log = Logger.getLogger(MyShibAuthentication.class);
    ...
    public int authenticate(Context context, String username, String password,
        ...
        System.out.println("MyShibAuthentication.authenticate() was called");
        log.info("MyShibAuthentication.authenticate() was called");
    ...
    public List<Group> getSpecialGroups(Context context, HttpServletRequest request) {
        ...
        System.out.println("MyShibAuthentication.getSpecialGroups() was called");
        log.info("MyShibAuthentication.getSpecialGroups() was called");
    ...
    public boolean allowSetPassword(Context context,
        ...
        System.out.println("MyShibAuthentication.allowSetPassword() was called");
        log.info("MyShibAuthentication.allowSetPassword() was called");
        return false;
    }
    ...
    public boolean isImplicit() {
        System.out.println("MyShibAuthentication.isImplicit() was called");
        log.info("MyShibAuthentication.isImplicit() was called");
    ...
    public boolean canSelfRegister(Context context, HttpServletRequest request,
        ...
        System.out.println("MyShibAuthentication.canSelfRegister() was called");
        log.info("MyShibAuthentication.canSelfRegister() was called");
    ...
    public void initEPerson(Context context, HttpServletRequest request,
        ...
        System.out.println("MyShibAuthentication.initEPerson() was called");
        log.info("MyShibAuthentication.initEPerson() was called");
    ...
    public String loginPageURL(Context context, HttpServletRequest request, HttpServletResponse response) {
        ...
        System.out.println("MyShibAuthentication.loginPageURL() was called");
        log.info("MyShibAuthentication.loginPageURL() was called");
        ...
        if (lazySession) {
            ...
            log.info("Redirecting user to Shibboleth initiator: " + shibURL);
    ...
    public String getName() {
        System.out.println("MyShibAuthentication.getName() was called");
        log.info("MyShibAuthentication.getName() was called");
    ...
    protected EPerson findEPerson(Context context, HttpServletRequest request) throws SQLException, AuthorizeException {
        ...
        System.out.println("MyShibAuthentication.findEPerson() was called");
        log.info("MyShibAuthentication.findEPerson() was called");
    ...
    protected EPerson registerNewEPerson(Context context, HttpServletRequest request)
        ...
        System.out.println("MyShibAuthentication.registerNewEperson() was called");
        log.info("MyShibAuthentication.registerNewEperson() ws callled");
    ...
    protected void updateEPerson(Context context, HttpServletRequest request, EPerson eperson)
        ...
        System.out.println("MyShibAuthentication.updateEperson() was called");
        log.info("MyShibAuthentication.updateEperson() was called");
    ...
    protected int swordCompatibility(Context context, String username, String password, HttpServletRequest request)
        ...
        System.out.println("MyShibAuthentication.swordCompatibatility() was called");
        log.info("MyShibAuthentication.swordCompatibatillity() was called");
    ...
    protected synchronized void initialize(Context context) throws SQLException {
        ...
        System.out.println("MyShibAuthentication.initialize() was called");
        log.info("MyShibAuthentication.initialize() was called");
    ...
    protected synchronized boolean checkIfEpersonMetadataFieldExists(Context context, String metadataName)
        ...
        System.out.println("MyShibAuthentication.checkIfEpersonMetadataFieldExists() was called");
        log.info("MyShibAuthentication.checkIfEpersonMetadataFieldExists() was called");
    ...
    protected synchronized boolean autoCreateEpersonMetadataField(Context context, String metadataName)
        ...
        System.out.println("MyShibAuthentication.autoCreateEPersonMetadataField() was called");
        log.info("MyShibAuthentication.autoCreateEPersonMetadataField() was called");
    ...
    protected String findAttribute(HttpServletRequest request, String name) {
        ...
        System.out.println("MyShibAuthentication.findAttribute() was called");
        log.info("MyShibAuthentication.findAttribute() was called");
    ...
    protected String findSingleAttribute(HttpServletRequest request, String name) {
        ...
        System.out.println("MyShibAuthentication.findSingleAttribute() was called");
        log.info("MyShibAuthentication.findSingleAttribute() was called");
    ...
    protected List<String> findMultipleAttributes(HttpServletRequest request, String name) {
        ...
        System.out.println("MyShibAuthentication.findMultipleAttributes() was called");
        log.info("MyShibAuthentication.findMultipleAttributes() was called");
