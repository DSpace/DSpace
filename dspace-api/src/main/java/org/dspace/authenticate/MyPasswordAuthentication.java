 ...
 * @version $Revision$
 */
public class MyPasswordAuthentication
        implements AuthenticationMethod {

    /**
     * log4j category
     */
    private static Logger log = Logger.getLogger(MyPasswordAuthentication.class);
    ...
    public boolean canSelfRegister(Context context,
                                   ...
                                   String email)
            throws SQLException {
        System.out.println("MyPasswordAuthentication.canSelfRegister() was called");
        log.info("MyPasswordAuthentication.canSelfRegister() was called");
    ...
    public void initEPerson(Context context, HttpServletRequest request,
                            EPerson eperson)
            throws SQLException {
        System.out.println("MyPasswordAuthentication.initEPerson() was called");
        log.info("MyPasswordAuthentication.initEPerson() was called");
    }
    ...
    public boolean allowSetPassword(Context context,
                                    ...
                                    String username)
            throws SQLException {
        System.out.println("MyPasswordAuthentication.allowSetPassword() was called");
        log.info("MyPasswordAuthentication.allowSetPassword() was called");
        return true;
    }
    ...
    public boolean isImplicit() {
        System.out.println("MyPasswordAuthentication.isImplicit() was called");
        log.info("MyPasswordAuthentication.isImplicit() was called");
    ...
    public List<Group> getSpecialGroups(Context context, HttpServletRequest request) {
        ...
        System.out.println("MyPasswordAuthentication.getSpecialGroups() was called");
        log.info("MyPasswordAuthentication.getSpecialGroups() was called");
    ...
    public int authenticate(Context context,
                            ...
                            HttpServletRequest request)
            throws SQLException {
        System.out.println("MyPasswordAuthentication.authenticate() was called");
        log.info("MyPasswordAuthentication.authenticate() was called");
    ...
    public String loginPageURL(Context context,
        ...
        System.out.println("MyPasswordAuthentication.loginPageURL() was called");
        log.info("MyPasswordAuthentication.loginPageURL() was called");
    ...
    public String getName() {
        System.out.println("MyPasswordAuthentication.getName() was called");
        log.debug("MyPasswordAuthentication.getName() was called");
