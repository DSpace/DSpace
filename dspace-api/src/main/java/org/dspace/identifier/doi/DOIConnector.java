...
public interface DOIConnector {
     ...
     * DOIConnector won't do any tests and throws an IdentifierException in case
     * of any problems with the DOI you want to reserve.
     * 
     * @param context
     * @param dso
     * @param doi
     ...
     * do any tests and throws an IdentifierException in case of any problems
