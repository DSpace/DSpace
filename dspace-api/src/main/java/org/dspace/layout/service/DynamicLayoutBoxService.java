 ...
 *
 */
public interface DynamicLayoutBoxService extends DSpaceCRUDService<DynamicLayoutBox> {

    /**
     * This method stores in the database a DynamicLayoutBox {@Link DynamicLayoutBox} instance
     * @param context The relevant DSpace Context
     * @param box DynamicLayoutBox instance to store in the database {@link DynamicLayoutBox}
     * @return the stored DynamicLayoutBox instance
    ...
    /**
     * Create and store in the database a new DynamicLayoutBox {@Link DynamicLayoutBox} instance
     * with required field
     * @param context The relevant DSpace Context
     ...
     * @throws SQLException An exception that provides information on a database errors.
     */
    public DynamicLayoutBox create(Context context, EntityType eType, String boxType, boolean collapsed, boolean minor)
     ...
     * @return List of DynamicLayoutBox {@link DynamicLayoutBox}
     * @throws SQLException An exception that provides information on a database errors.
     */
    public List<DynamicLayoutBox> findByEntityType(Context context, String entityType, Integer limit, Integer offset)
        throws SQLException;
     ...
     *
     * @param context The relevant DSpace Context
     * @param box     DynamicLayoutBox instance
     ...
     *
     * @param box     the DynamicLayoutBox
