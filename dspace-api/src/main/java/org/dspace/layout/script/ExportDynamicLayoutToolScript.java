 ...
 *
 */
public class ExportDynamicLayoutToolScript
    extends DSpaceRunnable<ExportDynamicLayoutToolScriptConfiguration<ExportDynamicLayoutToolScript>> {
    ...
    public void setup() throws ParseException {
        ...
        this.converter = DynamicLayoutServiceFactory.getInstance().getDynamicLayoutToolConverter();
    ...
    public ExportDynamicLayoutToolScriptConfiguration<ExportDynamicLayoutToolScript> getScriptConfiguration() {
        return new DSpace().getServiceManager().getServiceByName("export-dynamic-layout-tool",
            ExportDynamicLayoutToolScriptConfiguration.class);
    }
