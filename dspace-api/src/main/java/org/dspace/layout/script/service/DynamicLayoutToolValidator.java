...
import org.dspace.layout.script.DynamicLayoutToolScript;

/**
 * Validator for excel used by the {@link DynamicLayoutToolScript}.
 *
 * @author Luca Giamminonni (luca.giamminonni at 4science.it)
 *
 */
public interface DynamicLayoutToolValidator {
     ...
     */
    DynamicLayoutToolValidationResult validate(Context context, Workbook workbook);
