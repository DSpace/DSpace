...
/**
 * Database Access Object interface class for the DynamicLayoutField object {@link DynamicLayoutField}.
 ...
 *
 */
public interface DynamicLayoutFieldDAO extends GenericDAO<DynamicLayoutField> {

    /**
     * Returns the field that are available for specific Box
     * @param context The relevant DSpace Context
     * @param boxId id of box {@link DynamicLayoutBox}
     ...
     */
    public List<DynamicLayoutField> findByBoxId
