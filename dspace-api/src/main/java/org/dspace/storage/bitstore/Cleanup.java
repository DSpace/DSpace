...
public class Cleanup {
    ...
    public static void main(String[] argv) {
        try {
            ...
            options.addOption("l", "leave", false, "Leave database records but delete file from assetstore" + (versioning ? defaultSuffix : ""));
            options.addOption("d", "delete", false, "Delete database records as well as assetstore files" + (!versioning ? defaultSuffix : ""));
