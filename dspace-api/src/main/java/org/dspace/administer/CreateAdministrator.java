        ...
        if (line.hasOption("e") && line.hasOption("f") && line.hasOption("l") &&
            ...
            if (line.hasOption("h") && (!line.hasOption("e") || !line.hasOption("f") || !line.hasOption("l") ||
                ...
                String header = "\nA command-line tool for creating an initial administrator for setting up a" +
					...
					" prompt for an e-mail address, last name, first name and password from standard input." +
					" An administrator group is then created and the data passed in used" +
                    " to create an e-person in that group.\n\n";
			    String footer = "\n";
