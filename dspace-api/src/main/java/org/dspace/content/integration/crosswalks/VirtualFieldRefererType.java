...
public class VirtualFieldRefererType implements VirtualFieldDisseminator, VirtualFieldIngester {
    ...
    public String[] getMetadata(Item item, Map<String, String> fieldCache, String fieldName) {
        ...
        String type = ConfigurationManager
                .getProperty("crosswalk.virtualname.referer.type." + qualifier + "." + fieldCache.get("formAlias"));
        if (StringUtils.isNotBlank(type)) {
            return new String[] { type };
        }
        return new String[] { ConfigurationManager.getProperty("crosswalk.virtualname.referer.type." + qualifier) };
    }
