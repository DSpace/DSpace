...
public interface BitstreamLinkingService {
     ...
     * @param newName an optional new name to assign to this Bitstream
     * @throws AuthorizeException If the user inside of context is not authorized to do this
     * @throws SQLException if database error
     */
    void replaceMetadata(Context context, Bitstream bitstream, Bitstream replacedBy, String newName)
