...
public class Concept2TermRole
{
    ...
    /** log4j logger */
    private static Logger log = Logger.getLogger(Concept2TermRole.class);

    /** The row in the table representing this type */
    private TableRow row;

    // cache of relation by ID (Integer)
    private static Map<Integer, Concept2TermRole> id2relation = null;


    /**
     * Default constructor.
     */
    public Concept2TermRole()
    {
    }
     ...
     */
    public Concept2TermRole(String role, String label, String scopeNote)
    {
        this.role = role;
        this.label = label;
     ...
     */
    public Concept2TermRole(TableRow row)
    {
        if (row != null)
        {
            ...
            SQLException, NonUniqueMetadataException
    {
        ...
        row = DatabaseManager.row("Concept2TermRole");
            ...
            AuthorizeException
    {
        ...
        if (label == null)
        {
            tri = DatabaseManager.queryTable(context,"Concept2TermRole",
                    "SELECT * FROM Concept2TermRole WHERE " +
        ...
        {
            return new Concept2TermRole(row);
        }
    }
     ...
     * @throws java.sql.SQLException
     */
    public static Concept2TermRole[] findAll(Context context) throws SQLException
    {
        List<Concept2TermRole> relations = new ArrayList<Concept2TermRole>();
        ...
        try
        {
            ...
            while (tri.hasNext())
            {
                relations.add(new Concept2TermRole(tri.next()));
            }
        }
        finally
        {
        ...
        Concept2TermRole[] typeArray = new Concept2TermRole[relations.size()];
        return (Concept2TermRole[]) relations.toArray(typeArray);
    }
     ...
     * @throws java.sql.SQLException
     */
    public static Concept2TermRole[] findAllInSchema(Context context, int schemaID)
            throws SQLException
    {
        List<Concept2TermRole> relations = new ArrayList<Concept2TermRole>();
            ...
            AuthorizeException, NonUniqueMetadataException, IOException
    {
        ...
        if (Concept2TermRole.hasElement(context, role, label))
        {
        ...
        log.info(LogManager.getHeader(context, "update_Concept2TermRole",
    ...
    public void delete(Context context) throws SQLException, AuthorizeException
    {
        ...
        {
            throw new AuthorizeException(
                    "Only administrators may modify the Concept2TermRole registry");
        }

        log.info(LogManager.getHeader(context, "delete_Concept2TermRole",
                "id=" + getRelationID()));
            ...
            AuthorizeException
    {
        ...
        try
        {
            ...
            TableRow reg = DatabaseManager.row("Concept2TermRole");
     ...
     * @throws java.sql.SQLException
     */
    public static Concept2TermRole find(Context context, int id)
            throws SQLException
    {
    ...
    private static synchronized void initCache(Context context) throws SQLException
    {
        if (!isCacheInitialized())
        {
            Map<Integer, Concept2TermRole> new_id2relation = new HashMap<Integer, Concept2TermRole>();
            log.info("Loading Concept2TermRole elements into cache.");
            ...
            try
            {
                while (tri.hasNext())
                {
                    ...
                    new_id2relation.put(Integer.valueOf(relationID), new Concept2TermRole(row));
                }
            }
            finally
            {
