...
public class ItemRelationshipsType implements ReloadableEntity<Integer> {
     ...
     */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "item_relationships_type_id_seq")
    @SequenceGenerator(name = "item_relationships_type_id_seq", sequenceName = "item_relationships_type_id_seq",
        allocationSize = 1)
