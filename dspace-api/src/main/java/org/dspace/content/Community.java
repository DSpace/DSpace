...
public class Community extends DSpaceObject
{
    ...
    Community(Context context, TableRow row) throws SQLException
    {
        ...
        {
            logo = Bitstream.find(getContext(), communityRow
    ...
    public void update() throws SQLException, IOException, AuthorizeException
    {
        ...
        log.info(LogManager.getHeader(getContext(), "update_community",
                "community_id=" + getID()));

        DatabaseManager.update(getContext(), communityRow);

        if (modified)
        {
            getContext().addEvent(new Event(Event.MODIFY, Constants.COMMUNITY, getID(), null));
            modified = false;
        }
        if (modifiedMetadata)
        {
            getContext().addEvent(new Event(Event.MODIFY_METADATA, Constants.COMMUNITY, getID(), getDetails()));
            modifiedMetadata = false;
            clearDetails();
        }
    }
    ...
    public Group createAdministrators() throws SQLException, AuthorizeException
    {
        ...
        AuthorizeManager.addPolicy(getContext(), this, Constants.ADMIN, admins);
    ...
    public Community[] getSubcommunities() throws SQLException
    {
        ...
        try
        {
            while (tri.hasNext())
            {
                ...
                // First check the cache
                Community fromCache = (Community) getContext().fromCache(
                        Community.class, row.getIntColumn("community_id"));
                ...
                {
                    subcommunities.add(new Community(getContext(), row));
                }
            }
        }
        finally
    ...
    public Community getParentCommunity() throws SQLException
    {
        ...
        try
        {
            if (tri.hasNext())
            {
                ...
                {
                    parentCommunity = new Community(getContext(), row);
                }
            }
        }
        finally
            ...
            AuthorizeException
    {
        ...
        Collection c = Collection.create(getContext(), handle);
        addCollection(c);
            ...
            AuthorizeException
    {
        ...
        log.info(LogManager.getHeader(getContext(), "add_collection",
                "community_id=" + getID() + ",collection_id=" + c.getID()));

        // Find out if mapping exists
        TableRowIterator tri = DatabaseManager.queryTable(getContext(),
        ...
        try
        {
            if (!tri.hasNext())
            {
                ...
                getContext().addEvent(new Event(Event.ADD, Constants.COMMUNITY, getID(), Constants.COLLECTION, c.getID(), c.getHandle()));
            ...
            AuthorizeException
    {
        ...
        Community c = create(this, getContext(), handle);
        addSubcommunity(c);
            ...
            AuthorizeException
    {
        ...
        log.info(LogManager.getHeader(getContext(), "add_subcommunity",
        ...
        try
        {
            if (!tri.hasNext())
            {
                ...
                getContext().addEvent(new Event(Event.ADD, Constants.COMMUNITY, getID(), Constants.COMMUNITY, c.getID(), c.getHandle()));
            ...
            AuthorizeException, IOException
    {
        ...
        TableRow trow = DatabaseManager.querySingle(getContext(),
                "SELECT COUNT(DISTINCT community_id) AS num FROM community2collection WHERE collection_id= ? ",
                c.getID());
        DatabaseManager.setConstraintDeferred(getContext(), "comm2coll_collection_fk");
        ...
        log.info(LogManager.getHeader(getContext(), "remove_collection",
                "community_id=" + getID() + ",collection_id=" + c.getID()));
        ...
        DatabaseManager.setConstraintImmediate(getContext(), "comm2coll_collection_fk");
        
        getContext().addEvent(new Event(Event.REMOVE, Constants.COMMUNITY, getID(), Constants.COLLECTION, c.getID(), c.getHandle()));
    }
            ...
            AuthorizeException, IOException
    {
        ...
        DatabaseManager.setConstraintDeferred(getContext(), "com2com_child_fk");
        if (trow.getLongColumn("num") == 1)
        {
            // Orphan; delete it
            c.rawDelete();
        ...
        log.info(LogManager.getHeader(getContext(), "remove_subcommunity",
                "parent_comm_id=" + getID() + ",child_comm_id=" + c.getID()));
        ...
        getContext().addEvent(new Event(Event.REMOVE, Constants.COMMUNITY, getID(), Constants.COMMUNITY, c.getID(), c.getHandle()));
        
        DatabaseManager.setConstraintImmediate(getContext(), "com2com_child_fk");
    }
    ...
    public void delete() throws SQLException, AuthorizeException, IOException
    {
        ...
        if (!AuthorizeManager.authorizeActionBoolean(getContext(),
                getParentCommunity(), Constants.REMOVE))
        {
            AuthorizeManager
                    .authorizeAction(getContext(), this, Constants.DELETE);
        }
    ...
    {
        log.info(LogManager.getHeader(getContext(), "delete_community",
                "community_id=" + getID()));

        getContext().addEvent(new Event(Event.DELETE, Constants.COMMUNITY, getID(), getHandle()));
        ...
        DatabaseManager.delete(getContext(), communityRow);
    ...
    private Group groupFromColumn(String col) throws SQLException
    {
        ...
        return Group.find(getContext(), communityRow.getIntColumn(col));
    }
