...
public interface RelationshipDAO extends GenericDAO<Relationship> {
     ...
     * @throws SQLException If something goes wrong
     */
    List<Relationship> findByRelationshipType(Session session, RelationshipType relationshipType,
     ...
     * @throws SQLException If something goes wrong
     */
    List<Relationship> findByTypeName(Session session, String typeName)
            throws SQLException;
     ...
     * @throws SQLException if database error
     */
    int countByRelationshipType(Session session, RelationshipType relationshipType) throws SQLException;
     ...
     * @throws SQLException If something goes wrong
     */
    int countByItem(Session session, Item item, boolean excludeTilted, boolean excludeNonLatest) throws SQLException;
     ...
     * @throws SQLException if database error
     */
    int countByTypeName(Session session, String typeName)
            throws SQLException;
     ...
     *
     * @param session            DSpace context object
     ...
     * @throws SQLException      If database error
     */
    List<Relationship> findByItemAndRelationshipTypeAndList(Session session, UUID focusUUID,
     ...
     * @throws SQLException      If database error
     */
    int countByItemAndRelationshipTypeAndList(Session session, UUID focusUUID, RelationshipType relationshipType,
