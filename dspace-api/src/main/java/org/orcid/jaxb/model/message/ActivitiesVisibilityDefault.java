...
public class ActivitiesVisibilityDefault implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlValue
    protected Visibility value;

    public ActivitiesVisibilityDefault() {
        super();
    }

    public ActivitiesVisibilityDefault(Visibility value) {
        super();
        this.value = value;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ActivitiesVisibilityDefault other = (ActivitiesVisibilityDefault) obj;
