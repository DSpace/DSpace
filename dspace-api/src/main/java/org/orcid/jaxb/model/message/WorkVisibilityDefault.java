...
@XmlRootElement(name = "work-visibility-default")
public class WorkVisibilityDefault implements Serializable {

    private final static long serialVersionUID = 1L;
    @XmlValue
    protected Visibility value;

    public WorkVisibilityDefault() {
        super();
    }

    public WorkVisibilityDefault(Visibility value) {
        super();
        this.value = value;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        WorkVisibilityDefault other = (WorkVisibilityDefault) obj;
