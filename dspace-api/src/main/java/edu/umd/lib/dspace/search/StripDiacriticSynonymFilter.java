...
public class StripDiacriticSynonymFilter extends TokenFilter {
  ...
  public final Token next() throws IOException {
    ...
    StringBuffer sb = new StringBuffer(Normalizer.normalize(token.termText(), Normalizer.NFD)); 
   ...
   * It's not clear the performance improvement is significant but it's 
