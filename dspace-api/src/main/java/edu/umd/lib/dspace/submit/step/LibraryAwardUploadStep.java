...
public class LibraryAwardUploadStep extends AbstractProcessingStep
{
            ...
            SQLException, AuthorizeException
    {
    	...
    	for (String required : requiredBitstreams) {
        	log.debug(LogManager.getHeader(context, "la_get_needed", required + " is required"));
    		...
    		for (Bitstream b : subInfo.getSubmissionItem().getItem().getNonInternalBitstreams()) {
    	    	...
    	    	log.debug(LogManager.getHeader(context, "la_get_needed", "checking for match on " + desc));
        	...
        	log.debug(LogManager.getHeader(context, "la_get_needed", required + " is already present " + alreadyPresent));
    	...
    	log.debug(LogManager.getHeader(context, "la_get_needed", "returning " + needed));
