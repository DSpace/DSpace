...
create table cris_weperson (id int4 not null, groupName varchar(255), primary key (id));
create table cris_wgroup (id int4 not null, regex varchar(255), primary key (id));
