...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM">
        ...
        <xsl:if test="confman:getProperty('altmetric.enabled') = 'true' and ($identifier_doi or $identifier_handle)">
            <xsl:call-template name='impact-altmetric'/>
        </xsl:if>
        <xsl:if test="confman:getProperty('plumx.enabled') = 'true' and $identifier_doi">
    ...
    <xsl:template name='impact-altmetric'>
        <div id='impact-altmetric'>
            ...
            <div id='altmetric'
                ...
                <xsl:if test="confman:getProperty('altmetric.noScore') = 'true'">
                    <xsl:attribute name='data-no-score'>true</xsl:attribute>
                </xsl:if>

                <xsl:if test="confman:getProperty('altmetric.hideNoMentions') = 'true'">
    ...
    <xsl:template name="impact-plumx">
        <div id="impact-plumx" style="clear:right">
            ...
            <a>
                ...
                <xsl:if test="confman:getProperty('plumx.data-hide-when-empty') = 'true'">
                    <xsl:attribute name="data-hide-when-empty">true</xsl:attribute>
                </xsl:if>

                <xsl:if test="confman:getProperty('plumx.data-hide-print') = 'true'">
                ...
                <xsl:if test="confman:getProperty('plumx.data-border') = 'true'">
