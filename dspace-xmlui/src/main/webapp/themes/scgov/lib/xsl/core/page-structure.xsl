        ...
        <div id="ds-footer-wrapper">
            <div id="ds-footer">
                ...
                <div id="ds-footer-links">
                    <a href="http://mobile.dc.statelibrary.sc.gov/">View mobile site</a>&#160;&#160;|&#160;&#160;
                    <a>
                        <xsl:attribute name="href">
                            <xsl:value-of
                                    select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='contextPath'][not(@qualifier)]"/>
...
-->
    ...
    <xsl:template match="dri:body">
	  ...
	  <xsl:variable name="request_uri" select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='request'][@qualifier='URI']" />
          <xsl:if test="$request_uri = ''">
	    <div id="sc-banner-holder"><img src="/themes/scgov/images/banner.jpg" alt="Banner" /></div>
          </xsl:if>
