...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM-fields">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 8 and (dim:field[@mdschema='ts' and @element='plotid'])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-plotid</i18n:text>:</span>
	                <span>
	                <xsl:for-each select="dim:field[@mdschema='ts' and @element='plotid']">
		                <xsl:copy-of select="./node()"/>
	              	</xsl:for-each>
	                </span>
	            </div>
          ...
          <xsl:when test="$clause = 9 and (dim:field[@mdschema='ts' and @element='firstname'])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-firstname</i18n:text>:</span>
	                <span>
	                <xsl:for-each select="dim:field[@mdschema='ts' and @element='firstname']">
		                <xsl:copy-of select="./node()"/>
	              	</xsl:for-each>
	                </span>
	            </div>
          ...
          <xsl:when test="$clause = 10 and (dim:field[@mdschema='ts' and @element='middlename'])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-middlename</i18n:text>:</span>
	                <span>
	                <xsl:for-each select="dim:field[@mdschema='ts' and @element='middlename']">
		                <xsl:copy-of select="./node()"/>
	              	</xsl:for-each>
	                </span>
	            </div>
          ...
          <xsl:when test="$clause = 11 and (dim:field[@mdschema='ts' and @element='lastname'])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-lastname</i18n:text>:</span>
	                <span>
	                <xsl:for-each select="dim:field[@mdschema='ts' and @element='lastname']">
		                <xsl:copy-of select="./node()"/>
	              	</xsl:for-each>
	                </span>
	            </div>
          ...
          <xsl:when test="$clause = 12 and (dim:field[@mdschema='ts' and @element='birthday'])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-birthday</i18n:text>:</span>
	                <span>
	                <xsl:for-each select="dim:field[@mdschema='ts' and @element='birthday']">
		                <xsl:copy-of select="./node()"/>
	              	</xsl:for-each>
	                </span>
	            </div>
          ...
          <xsl:when test="$clause = 13 and (dim:field[@mdschema='ts' and @element='deathday'])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-deathday</i18n:text>:</span>
	                <span>
	                <xsl:for-each select="dim:field[@mdschema='ts' and @element='deathday']">
		                <xsl:copy-of select="./node()"/>
	              	</xsl:for-each>
	                </span>
	            </div>
          ...
          <xsl:when test="$clause = 14 and (dim:field[@mdschema='ts' and @element='cemetery'])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-cemetery</i18n:text>:</span>
	                <span>
	                <xsl:for-each select="dim:field[@mdschema='ts' and @element='cemetery']">
		                <xsl:copy-of select="./node()"/>
	              	</xsl:for-each>
	                </span>
	            </div>
          ...
          <xsl:when test="$clause = 15 and (dim:field[@mdschema='ts' and @element='text'])">
                    <div class="simple-item-view-description">
	                <h3><i18n:text>xmlui.dri2xhtml.METS-1.0.item-text</i18n:text>:</h3>
	                <div>
	                <xsl:for-each select="dim:field[@mdschema='ts' and @element='text']">
                    		<xsl:call-template name="scgovInsertBreaks">
                    		</xsl:call-template>
	              	</xsl:for-each>
	                </div>
	            </div>
          ...
          <xsl:when test="$clause = 16 and (dim:field[@element='notes' and not(@qualifier)])">
                <div class="simple-item-view-description">
	                <h3 class="bold">Notes:</h3>
	                <div>
	                <xsl:if test="count(dim:field[@element='notes' and not(@qualifier)]) &gt; 1 and not(count(dim:field[@element='notes' and @qualifier='abstract']) &gt; 1)">
                        <div class="spacer">&#160;</div>
	                </xsl:if>
	                <xsl:for-each select="dim:field[@element='notes' and not(@qualifier)]">
		                <xsl:copy-of select="./node()"/>
		                <xsl:if test="count(following-sibling::dim:field[@element='notes' and not(@qualifier)]) != 0">
                            <div class="spacer">&#160;</div>
	                    </xsl:if>
	               	</xsl:for-each>
	               	<xsl:if test="count(dim:field[@element='notes' and not(@qualifier)]) &gt; 1">
                           <div class="spacer">&#160;</div>
	                </xsl:if>
	                </div>
	            </div>
...
-->
            ...
            <div class="file-metadata" style="height: {$thumbnail.maxheight}px;">
                <div>
                    ...
                    <span>
                        ...
                        <xsl:value-of select="util:shortenString(mets:FLocat[@LOCTYPE='URL']/@xlink:title, 40, 5)"/>
                    </span>
                </div>
  ...
  <xsl:template match="text()" name="scgovInsertBreaks">
