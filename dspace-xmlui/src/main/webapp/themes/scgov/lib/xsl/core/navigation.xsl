...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template match="dri:options">
		...
		<br/>
		<h1 id="ds-search-option-head" class="ds-option-set-head">Pages</h1>
		<div id="ds-search-option" class="ds-option-set" xmlns:i18n="http://apache.org/cocoon/i18n/2.1">
			<div><a href="/dspace_about.html">About Us</a></div>
		</div>
