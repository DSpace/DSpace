...
<xsl:stylesheet
    ...
    <xsl:template name="itemDetailView-DIM">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <p>This is only an index and does not contain a digital copy of this article.
                To request a photocopy of this article, please contact the Reference
                Department at the Main Library in Rock Hill by calling (803) 981-5825 or by
                email at <a href="mailto:reference@yclibrary.net"> reference@yclibrary.net</a>. Please
                note, charges may apply and not all articles are available to be photocopied
                due to copyright restrictions.</p>
            </xsl:otherwise>
        </xsl:choose>
