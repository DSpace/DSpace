...
<xsl:stylesheet
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <xsl:call-template name="itemSummaryView-DIM-relation-pdf"/>
    ...
    <xsl:template name="itemSummaryView-DIM-relation-pdf">
        <xsl:if test="dim:field[@element='relation'][@qualifier='pdf' and descendant::text()]">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>Link to File:</h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='relation'][@qualifier='pdf']">
                        <xsl:for-each select="dim:field[@element='relation'][@qualifier='pdf']">
                            <a class="ellipsis">
...
<xsl:template name="itemSummaryView-show-full">
    ...
    <xsl:template name="itemSummaryView-DIM-file-section">
        <xsl:if test="//mets:fileSec/mets:fileGrp[@USE='CONTENT' or @USE='ORIGINAL' or @USE='LICENSE']/mets:file">
            <h5><i18n:text>xmlui.dri2xhtml.METS-1.0.item-files-view</i18n:text></h5>
   ...
   <xsl:template match="mets:fileGrp[@USE='LICENSE']">
    ...
    <xsl:template match="mets:file" mode="snazy">
        ...
        <li>
            ...
            <xsl:choose>
            <xsl:when test="$mview='googleplayer' or $mview='html5video' or $mview='videoplayer' or $mview='audioplayer' or $mview='googledocsviewer' or $mview='embedwithfallback' or $mview='image'">
