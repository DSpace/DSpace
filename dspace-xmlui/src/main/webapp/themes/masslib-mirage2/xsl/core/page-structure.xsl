        ...
        <head>
            ...
            <link rel="apple-touch-icon" sizes="57x57">
                <xsl:attribute name="href">
                    ...
                    <xsl:text>images/favicons/apple-touch-icon-57x57.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon" sizes="60x60">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/apple-touch-icon-60x60.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon" sizes="72x72">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/apple-touch-icon-72x72.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon" sizes="76x76">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/apple-touch-icon-76x76.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon" sizes="114x114">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/apple-touch-icon-114x114.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon" sizes="120x120">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/apple-touch-icon-120x120.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon" sizes="144x144">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/apple-touch-icon-144x144.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon" sizes="152x152">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/apple-touch-icon-152x152.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon" sizes="180x180">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/apple-touch-icon-180x180.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="icon" type="image/png" sizes="32x32">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/favicon-32x32.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="icon" type="image/png" sizes="192x192">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/android-chrome-192x192.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="icon" type="image/png" sizes="96x96">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/favicon-96x96.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="icon" type="image/png" sizes="16x16">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/favicons/favicon-16x16.png</xsl:text>
                </xsl:attribute>
            </link>
