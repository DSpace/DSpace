...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM-fields">
      ...
      <xsl:choose>
          ...
          <!-- MBL custom relation.uri row -->
          <xsl:when test="$clause = 4 and (dim:field[@element='relation' and @qualifier='uri'])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-relation-uri</i18n:text>:</span>
	                <span>
          ...
          <!-- date.issued row -->
          <xsl:when test="$clause = 5 and (dim:field[@element='date' and @qualifier='issued' and descendant::text()])">
                    <div class="simple-item-view-other">
          ...
          <!-- MBL custom date.created row -->
          <xsl:when test="$clause = 6 and (dim:field[@element='date' and @qualifier='created'])">
                    <div class="simple-item-view-date-created">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-date-created</i18n:text>:</span>
	                <span>
          ...
          <!-- MBL custom coverage  row -->
          <xsl:when test="$clause = 7 and (dim:field[@element='coverage' and @qualifier='spatial'])">
                    <div class="simple-item-view-coverage">
	                <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-coverage-spatial</i18n:text>:</span>
	                <span>
          ...
          <!-- MBL Custom relation ispartof row -->
          <xsl:when test="$clause = 9 and (dim:field[@element='relation' and @qualifier='ispartof'])">
                <div class="simple-item-view-ispartof">
	                <span class="bold">Related Material/Data:</span>
	                <span>
          ...
          <xsl:when test="$clause = 10 and (dim:field[@element='relation' and @qualifier='haspart'])">
                <div class="simple-item-view-haspart">
	                <span class="bold">Related Material/Data:</span>
	                <span>
          ...
          <xsl:when test="$clause = 11 and (dim:field[@element='relation' and @qualifier='requires'])">
                <div class="simple-item-view-requires">
	                <span class="bold">Related Material/Data:</span>
	                <span>
          ...
          <!-- MBL Custom DOI row -->
          <xsl:when test="$clause = 12 and (dim:field[@element='identifier' and @qualifier='doi'])">
                <div class="simple-item-view-doi">
          ...
          <!-- Abstract row -->
          <xsl:when test="$clause = 13 and (dim:field[@element='description' and @qualifier='abstract' and descendant::text()])">
          ...
          <!-- MBL Custom embargo liftdate row -->
