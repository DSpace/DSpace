...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHead">
        <head>
            ...
            <!-- link media="all and (min-width: 480px)" rel="stylesheet" href="//f.fontdeck.com/s/css/Z+vN0guBB5267JcQC3urXm7kGbw/allegheny.edu/30470.css" type="text/css" /-->
...
-->
    ...
    <xsl:template name="addJavascript">
        ...
        <!-- Allegheny customization  (ABV-311231) -->
        <script type="text/javascript" src="https://www.surveymonkey.com/jsPop.aspx?sm=zggnW_2fYn9Bip3U6AcfGLLA_3d_3d">&#160;</script>
    </xsl:template>
