    ...
    autocomplete_solr: function (obj, url, updater_function) {
        ufal.submissions.configurable_autocomplete_solr(
            ...
            function (item, values) {
                var used_by = "";
                if (0 < values[item]) {
                    used_by = "<span class='font_smaller'>(used by #" + values[item] + ")</span>";
                }
        ...
        ufal.submissions.configurable_autocomplete_solr(
            ...
            function (item, values) {
                ...
                if (item in values && 0 < values[item]) {
                    used_by = "<br /><span class='font_smaller label label-primary'>used by "
                        + values[item] + " submission(s)</span>";
                }
                return "<dl class='dl-horizontal'>" +
                    "<dt style='width: 110px;'>Funding code:</dt>" +
                    "<dd style='padding-left: 0px;'>" +
                    funding_code +
                    "</dd>" +
                    "<dt style='width: 110px;'>Project name:</dt>" +
                    "<dd style='padding-left: 0px;'>" +
                    project_name +
                    used_by +
                    "</dd></dl>";
