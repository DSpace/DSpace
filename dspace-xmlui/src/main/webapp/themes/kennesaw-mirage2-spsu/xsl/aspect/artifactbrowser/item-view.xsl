                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <xsl:call-template name="itemSummaryView-relationIsPartOf"/>
...
<xsl:template name="itemSummaryView-show-full">
    ...
    <xsl:template name="itemSummaryView-relationIsPartOf">
        <xsl:if test="dim:field[@element='relation' and @qualifier='ispartof']">
            <div class="simple-item-view-relationispartof item-page-field-wrapper table">
                <h5><i18n:text>xmlui.metadata.dc.relation.ispartof</i18n:text></h5>
                <div>
