...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM-fields">
      ...
      <xsl:choose>
		...
		<!-- KZOO Custom fields -->
          <xsl:when test="$clause = 5 and (dim:field[@element='contributor' and @qualifier='advisor'])">
                    <div class="simple-item-view-other">
	                <span class="bold">Advisor:</span>
	                <span>
          ...
          <xsl:when test="$clause = 6 and (dim:field[@element='rights' and not(@qualifier)])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 7 and (dim:field[@element='Access' and @qualifier='Contact'])">
                    <div class="simple-item-view-other">
	                <span class="bold">Access Contact:</span>
	                <span>
		                <xsl:for-each select="dim:field[@element='Access' and @qualifier='Contact']">
		                	<xsl:copy-of select="./node()"/>
		                	 <xsl:if test="count(following-sibling::dim:field[@element='Access' and @qualifier='Contact']) != 0">
	                    	<br/>
	                    </xsl:if>
		                </xsl:for-each>
	                </span>
          ...
          <!-- KZOO TOC row -->
          <xsl:when test="$clause = 8 and (dim:field[@element='description' and @qualifier='tableofcontents'])">
          ...
          <!-- Abstract row -->
          <xsl:when test="$clause = 9 and (dim:field[@element='description' and @qualifier='abstract'])">
                    <div class="simple-item-view-description">
          ...
          <!-- Description row -->
          <xsl:when test="$clause = 10 and (dim:field[@element='description' and not(@qualifier)])">
                <div class="simple-item-view-description">
