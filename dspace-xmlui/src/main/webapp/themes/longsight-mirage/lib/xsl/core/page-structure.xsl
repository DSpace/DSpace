        ...
        <div id="ds-footer-wrapper">
            <div id="ds-footer">
                <div id="ds-footer-left">
                    <a href="http://www.longsight.com/" target="_blank">Longsight</a> is a Registered Service Provider for DSpace, providing hosting, customization, and more to DSpace since 2005.
                </div>
...
-->
	...
	<!-- CUSTOM LONGSIGHT ZOOM -->
        <script type="text/javascript">
            <xsl:attribute name="src">
                <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='contextPath'][not(@qualifier)]"/>
                <xsl:text>/themes/</xsl:text>
                <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='theme'][@qualifier='path']"/>
                <xsl:text>/lib/js/cloud-zoom.1.0.2.js</xsl:text>
            </xsl:attribute>&#160;</script>
