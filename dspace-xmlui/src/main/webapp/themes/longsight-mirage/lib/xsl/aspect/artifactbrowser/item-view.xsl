            ...
            <div class="thumbnail-wrapper">
                <a class="image-link">
                    <xsl:attribute name="href">
                        ...
                        <xsl:if test="@SIZE &gt; 90000 and $context/mets:fileSec/mets:fileGrp[@USE='THUMBNAIL']/mets:file[@GROUPID=current()/@GROUPID]">
                    	    <xsl:attribute name="class">cloud-zoom</xsl:attribute>
                    	    <xsl:attribute name="id">zoom1</xsl:attribute>
                    	    <xsl:attribute name="rel">zoomWidth: 500, zoomHeight: 300, tint:'#ff0000', tintOpacity:0.5, adjustX:10, adjustY:-80</xsl:attribute>
                        </xsl:if>
                    <xsl:choose>
