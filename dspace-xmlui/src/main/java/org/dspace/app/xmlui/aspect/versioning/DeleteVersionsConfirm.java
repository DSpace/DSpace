...
public class DeleteVersionsConfirm extends AbstractDSpaceTransformer {
    ...
    private Division createMainDivision(Body body)
        throws WingException
    {
        Division main = body.addInteractiveDivision("versions-confirm-delete",
    ...
    private void addItemIdentifier(Cell cell, org.dspace.content.Item item)
        throws WingException {
        String itemHandle = item.getHandle();

        java.util.List<MetadataValue> identifiers = itemService.getMetadata(
            item, MetadataSchema.DC_SCHEMA, "identifier", null,
