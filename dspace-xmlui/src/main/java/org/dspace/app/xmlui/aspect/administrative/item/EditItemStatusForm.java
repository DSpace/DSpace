...
public class EditItemStatusForm extends AbstractDSpaceTransformer {
        ...
        throws SQLException, WingException
    {
        ...
        {
            itemInfo.addItem().addXref(DSpaceServicesFactory.getInstance()
                .getConfigurationService().getProperty("dspace.url") + "/handle/"
                    + item.getHandle(),DSpaceServicesFactory.getInstance().
    ...
    private void privateOrPublicAccess(Item item, List itemInfo)
     ...
     */
    private void addNotAllowedButton(org.dspace.app.xmlui.wing.element.Item item, String buttonName, Message buttonLabel)
        throws WingException, SQLException
    {
    ...
    private void addCollectionAdminOnlyButton(org.dspace.app.xmlui.wing.element.Item item, Collection collection, String buttonName, Message buttonLabel)
        throws WingException, SQLException
    {
        Button button = item.addButton(buttonName);
        button.setValue(buttonLabel);
