...
public class EditCollectionMetadataForm extends AbstractDSpaceTransformer   
{
            ...
            throws WingException, SQLException, AuthorizeException
    {
		...
		String baseURL = contextPath + "/admin/collection?administrative-continue=" + knot.getId();
            ...
            String short_description_error = FlowContainerUtils.checkXMLFragment(thisCollection.getMetadataSingleValue("short_description"));
	    String introductory_text_error = FlowContainerUtils.checkXMLFragment(thisCollection.getMetadataSingleValue("introductory_text"));
	    String copyright_text_error = FlowContainerUtils.checkXMLFragment(thisCollection.getMetadataSingleValue("copyright_text"));
	    String side_bar_text_error = FlowContainerUtils.checkXMLFragment(thisCollection.getMetadataSingleValue("side_bar_text"));
	    ...
	    name.setSize(40);
	    name.setValue(thisCollection.getMetadataSingleValue("name"));
	    
	    // short description
	    metadataList.addLabel(T_label_short_description);
	    Text short_description = metadataList.addItem().addText("short_description");
	    short_description.setValue(thisCollection.getMetadataSingleValue("short_description"));
	    ...
	    introductory_text.setValue(thisCollection.getMetadataSingleValue("introductory_text"));
	    ...
	    copyright_text.setValue(thisCollection.getMetadataSingleValue("copyright_text"));
	    ...
	    side_bar_text.setValue(thisCollection.getMetadataSingleValue("side_bar_text"));
	    ...
	    license.setValue(thisCollection.getMetadataSingleValue("license"));
	    ...
	    provenance_description.setValue(thisCollection.getMetadataSingleValue("provenance_description"));
