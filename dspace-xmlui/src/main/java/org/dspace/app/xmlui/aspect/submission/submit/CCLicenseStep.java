    ...
    UIException, SQLException, IOException, AuthorizeException
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if (selectedLicense != null &&
                selectedLicense.equals(cclicense.getLicenseId()))
            {
        ...
        if (selectedLicense  !=  null)
        {
            ...
            {
                Iterator outerIterator = cclookup.getLicenseFields(
                    selectedLicense, ccLocale).iterator();
                while (outerIterator.hasNext())
                {
                    ...
                    edit.addItem().addFigure(contextPath
                        + "/themes/Reference/images/information.png",
                        "javascript:void(0)", cclicensefield.getDescription(),
                        "information");
                    List subList = div.addList("sublist", List.TYPE_SIMPLE,
                        "horizontalVanilla");
                    Radio radio  = subList.addItem()
                        .addRadio(cclicensefield.getId() + "_chooser");
                    radio.setRequired();
                    Iterator fieldMapIterator =
                        cclicensefield.getEnum().entrySet().iterator();
        ...
        else
        {
            ...
            {
                statusList.addItem().addHighlight("error").addContent(
                    T_ccws_error.parameterize((String)session.getAttribute("ccError")));
            ...
            {
                statusList.addItem().addHighlight("italic").addContent(
                    T_save_changes);
            }
        }
