 ...
 */
public class SingleUserReviewAction extends AbstractXMLUIAction {
    ...
    protected static final Message T_cancel_submit =
        message("xmlui.general.cancel");
    private static final Message T_decline_submit = message("xmlui.XMLWorkflow.workflow.SingleUserReviewAction.decline.button");
    private static final Message T_decline_help = message("xmlui.Submission.workflow.SingleUserReviewAction.decline.help");
    ...
    private void renderMainPage(Division div) throws WingException {
        ...
        // Decline task
        row = table.addRow();
        row.addCellContent(T_decline_help);
        row.addCell().addButton("submit_decline_task").setValue(T_decline_submit);
