...
public class EditGroupForm extends AbstractDSpaceTransformer
{
        ...
        throws WingException, SQLException
    {
        ...
        //DIVISION: group-edit
        Division main = body.addInteractiveDivision("group-edit",
     ...
     */
    private void addEPeopleSearch(Division div, String query, int page, Group group, List<UUID> memberEPeopleIDs)
     ...
     */
    private void addGroupSearch(Division div, Group sourceGroup, String query, int page, Group parent, List<UUID> memberGroupIDs)
        throws WingException, SQLException
    {
...
//        Table table = results.addTable("roup-edit-search-group",groups.size() + 1, 1);
     ...
     */
    private boolean isDescendant(Group descendant, Group ancestor, List<UUID> memberGroupIDs)
        throws SQLException
    {
     ...
     * @throws SQLException
     */
    private boolean addMemberList(Division div, Group parent, List<UUID> memberGroupIDs, List<UUID> memberEPeopleIDs, String highlightEPersonID, String highlightGroupID)
        throws WingException, SQLException
    {
     ...
     */
    private void addMemberRow(Table table, Group group, boolean highlight, boolean pendingAddition, boolean pendingRemoval)
        throws WingException, SQLException
    {
        String name = group.getName();
     ...
     */
    private void addMemberRow(Table table, EPerson eperson, boolean highlight, boolean pendingAddition, boolean pendingRemoval)
        throws WingException, SQLException
    {
        String fullName = eperson.getFullName();
        String email = eperson.getEmail();
        String url = contextPath + "/admin/epeople?administrative-continue="
            + knot.getId() + "&submit_edit_eperson&epersonID=" + eperson.getID();
