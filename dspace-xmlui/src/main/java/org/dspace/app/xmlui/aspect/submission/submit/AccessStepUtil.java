...
public class AccessStepUtil extends AbstractDSpaceTransformer {
    ...
    {
        isAdvancedFormEnabled = DSpaceServicesFactory.getInstance()
            .getConfigurationService().getBooleanProperty(
                "webui.submission.restrictstep.enableAdvancedForm", false);
        context = c;
    }

    public void addName(String name_, List form, int errorFlag)
    ...
    public void addReason(String reason_, List form, int errorFlag)
        throws WingException
    {
        ...
        throws WingException, SQLException
    {
        ...
        if (isAdvancedFormEnabled)
        {
            ...
            // retrieve groups
            String name = DSpaceServicesFactory.getInstance()
    ...
    public void addAccessRadios(String selectedRadio, String date, List form, int errorFlag, DSpaceObject dso)
        throws WingException, SQLException
    {
    ...
    public void addEmbargoDateDisplayOnly(final DSpaceObject dso, final List list)
        ...
        throws WingException, SQLException
    {
        ...
        java.util.List<ResourcePolicy> resourcePolicies = authorizeService
            .findPoliciesByDSOAndType(context, dso, ResourcePolicy.TYPE_CUSTOM);
        ...
        throws WingException, SQLException
    {
        ...
        java.util.List<ResourcePolicy> resourcePolicies =
            authorizeService.findPoliciesByDSOAndType(
                context, dso, ResourcePolicy.TYPE_CUSTOM);
        if (resourcePolicies.isEmpty())
        {
