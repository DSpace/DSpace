...
public class FlowAuthorizationUtils {
     ...
     */
    public static FlowResult resolveItemIdentifier(Context context, String identifier)
        throws SQLException
    {
     ...
     */
    public static FlowResult processEditPolicy(Context context, int objectType,
        UUID objectID, int policyID, UUID groupID, int actionID, String name,
        String description, String startDateParam, String endDateParam)
        ...
        throws NumberFormatException, SQLException, AuthorizeException
    {
        ...
        result.setMessage(new Message("default",
            "The policies were deleted successfully"));
    ...
    public static FlowResult processAdvancedPolicyAdd(Context context,
        String[] groupIDs, int actionID, int resourceID, String[] collectionIDs,
        ...
        throws NumberFormatException, SQLException, AuthorizeException
    {
        ...
        for (String groupID : groupIDs)
        {
            ...
            {
                PolicySet.setPolicies(context, Constants.COLLECTION,
                    UUID.fromString(collectionID), resourceID, actionID,
                    UUID.fromString(groupID), false, false, name, description,
                    startDate, endDate);
                ...
                {
                    PolicySet.setPolicies(context, Constants.COLLECTION,
                        UUID.fromString(collectionID), Constants.BUNDLE,
                        actionID, UUID.fromString(groupID), false, false, name,
        ...
        throws NumberFormatException, SQLException, AuthorizeException
    {
        ...
        for (String collectionID : collectionIDs)
        {
            ...
            {
                PolicySet.setPolicies(context, Constants.COLLECTION,
                    UUID.fromString(collectionID), Constants.BUNDLE, 0, null,
                    false, true);
            }
        }
        ...
        result.setOutcome(true);
        result.setMessage(new Message("default",
            "The policies for the selected collections were cleared."));
