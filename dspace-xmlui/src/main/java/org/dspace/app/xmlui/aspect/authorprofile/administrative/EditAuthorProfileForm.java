...
public class EditAuthorProfileForm extends AbstractDSpaceTransformer {
	...
	String authorProfileMail=authorProfile.getMetadata("authorProfile.email");
        List<AuthorProfileInput> profileFields = authorProfileConfiguration.getAuthorProfileFields(context,authorProfileMail);
    ...
    public void addBody(Body body) throws SAXException, WingException, SQLException, IOException, AuthorizeException, ProcessingException {
        ...
        List<AuthorProfileInput> authorProfileFields;
        if(authorProfile==null){
            authorProfileFields=authorProfileConfiguration.getAuthorProfileFields();
        }else{
            String authorProfileMail=authorProfile.getMetadata("authorProfile.email");
            authorProfileFields = authorProfileConfiguration.getAuthorProfileFields(context,authorProfileMail);            
        }
