...
public class EditCommunityMetadataForm extends AbstractDSpaceTransformer   
{
            ...
            throws WingException, SQLException, AuthorizeException
	{
	    ...
	    String short_description_error = FlowContainerUtils.checkXMLFragment(thisCommunity.getMetadataSingleValue(Community.SHORT_DESCRIPTION));
	    String introductory_text_error = FlowContainerUtils.checkXMLFragment(thisCommunity.getMetadataSingleValue(Community.INTRODUCTORY_TEXT));
	    String copyright_text_error = FlowContainerUtils.checkXMLFragment(thisCommunity.getMetadataSingleValue(Community.COPYRIGHT_TEXT));
	    String side_bar_text_error = FlowContainerUtils.checkXMLFragment(thisCommunity.getMetadataSingleValue(Community.SIDEBAR_TEXT));
	    ...
	    name.setSize(40);
	    name.setValue(thisCommunity.getName());
	    
	    // short description
	    metadataList.addLabel(T_label_short_description);
	    Text short_description = metadataList.addItem().addText("short_description");
	    short_description.setValue(thisCommunity.getMetadataSingleValue(Community.SHORT_DESCRIPTION));
	    ...
	    introductory_text.setValue(thisCommunity.getMetadataSingleValue(Community.INTRODUCTORY_TEXT));
	    ...
	    copyright_text.setValue(thisCommunity.getMetadataSingleValue(Community.COPYRIGHT_TEXT));
	    ...
	    side_bar_text.setValue(thisCommunity.getMetadataSingleValue(Community.SIDEBAR_TEXT));
