...
public class FlowGroupUtils {
     ...
     */
    public static String getName(Context context, UUID groupID)
        throws SQLException
    {
        if (groupID == null)
        {
     ...
     * @throws java.sql.SQLException passed through.
     */
    public static String[] getEPeopleMembers(Context context, UUID groupID)
        throws SQLException
    {
     ...
     * @throws java.sql.SQLException passed through.
     */
    public static String[] getGroupMembers(Context context, UUID groupID)
        throws SQLException
    {
        if (groupID == null)
        {
