...
public class EditItemMetadataForm extends AbstractDSpaceTransformer {
        ...
        throws SQLException, WingException
    {
        ...
        for (MetadataValue value : values)
        {
                ...
                String fieldKey = metadataAuthorityService.makeFieldKey(
                    value.getMetadataField().getMetadataSchema().getName(),
                    value.getMetadataField().getElement(),
                    value.getMetadataField().getQualifier());
    ...
    static class DCValueComparator implements Comparator, Serializable {
        public int compare(Object arg0, Object arg1) {
            ...
            final String s1 = o1Field.getMetadataSchema().getName()
                + o1Field.getElement() + (o1Field.getQualifier() == null
                ? "" : ("." + o1Field.getQualifier()));
            final  String s2 = o2Field.getMetadataSchema().getName()
                + o2Field.getElement() + (o2Field.getQualifier() == null
                ? "" : ("." + o2Field.getQualifier()));
