...
public class ConfirmItemForm extends AbstractDSpaceTransformer {
        ...
        throws WingException, SQLException
    {
        ...
        final java.util.List<MetadataValue> values = itemService.getMetadata(
        ...
        for (final MetadataValue value:values)
        {
            ...
            final String dcValue = metadataField.getMetadataSchema().getName()
    ...
    static class DCValueComparator implements Comparator, Serializable {
        public int compare(Object arg0, Object arg1) {
            ...
            final String s1 = o1Field.getMetadataSchema().getName()
                + o1Field.getElement()
                + (o1Field.getQualifier() == null ? "" : ("." + o1Field.getQualifier()));
            final  String s2 = o2Field.getMetadataSchema().getName()
                + o2Field.getElement()
                + (o2Field.getQualifier() == null ? "" : ("." + o2Field.getQualifier()));
