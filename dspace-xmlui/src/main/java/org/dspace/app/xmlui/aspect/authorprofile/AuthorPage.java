...
//        div.setHead(T_PROFILE_HEAD.parameterize(fullName));
        ...
        if (AuthorizeManager.isAdmin(context) || (usuario!=null && authorProfileMail!=null && usuario.getEmail().equalsIgnoreCase(authorProfileMail)) ) {
    ...
    protected void addToValidity(DSpaceValidity validity) throws Exception{
        ...
        for (Metadatum value : authorProfile.getMetadata(AuthorProfile.AUTHOR_PROFILE_SCHEMA, "author", null, Item.ANY)) {
