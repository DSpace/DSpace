...
public class EditMetadataSchema extends AbstractDSpaceTransformer
{
        ...
        throws WingException, SQLException
    {
        ...
        Division main = body.addInteractiveDivision(
            "metadata-schema-edit", contextPath + "/admin/metadata-registry",
            Division.METHOD_POST, "primary administrative metadata-registry");
        ...
        for (MetadataField field : fields)
        {
            ...
            String url = contextPath + "/admin/metadata-registry?administrative-continue="
                 + knot.getId() + "&submit_edit&fieldID=" + id;
     ...
     */
    public void addNewFieldForm(Division div, String schemaName, java.util.List<String> errors)
        throws WingException
    {
     ...
     */
    public void addUpdateFieldForm(Division div, String schemaName, int fieldID, java.util.List<String> errors)
        throws WingException, SQLException
    {
     ...
     * @throws org.dspace.app.xmlui.wing.WingException passed through.
     */
    public void addFieldErrors(List form, java.util.List<String> errors)
        throws WingException
    {
