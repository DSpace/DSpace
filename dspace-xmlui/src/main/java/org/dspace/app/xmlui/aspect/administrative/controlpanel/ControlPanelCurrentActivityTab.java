...
public class ControlPanelCurrentActivityTab extends AbstractControlPanelTab {
    ...
    @Override
    public void addBody(Map objectModel, Division div)
        throws WingException, SQLException
    {
        ...
        java.util.List<CurrentActivityAction.Event> events =
            CurrentActivityAction.getEvents();
        Collections.sort(events,
            new ActivitySort<CurrentActivityAction.Event>(sortBy));
