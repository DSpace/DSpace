...
public class InvalidToken extends AbstractDSpaceTransformer
{
   ...
   public void addBody(Body body) throws WingException {
       ...
       example1.addContent(ConfigurationManager.getProperty("dspace.url") + "/set-email?token=ABCDEFGHIJK");
       ...
       example3.addContent(ConfigurationManager.getProperty("dspace.url") + "/set-email?token=ABCDEFGHIJKLMNOP");
