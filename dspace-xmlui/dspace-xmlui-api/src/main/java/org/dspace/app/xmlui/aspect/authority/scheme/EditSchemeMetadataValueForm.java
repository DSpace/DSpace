...
public class EditSchemeMetadataValueForm extends AbstractDSpaceTransformer {
    ...
    public void addBody(Body body) throws SQLException, WingException
    {
        ...
        AuthorityMetadataValue[] values = new AuthorityMetadataValue[scheme.getMetadata().size()];
        values = (AuthorityMetadataValue[])scheme.getMetadata().toArray(values);
...
//            options.addItem().addXref(baseURL + "&submit_curate", T_option_curate);
        ...
        addForm.addItem().addHidden("schemeID").setValue(schemeID);
