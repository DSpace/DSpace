...
public class EditConceptMetadataValueForm extends AbstractDSpaceTransformer {
    ...
    public void addBody(Body body) throws SQLException, WingException
    {
        ...
        AuthorityMetadataValue[] values = concept.getMetadata(Item.ANY, Item.ANY, Item.ANY, Item.ANY);
...
//            options.addItem().addXref(baseURL + "&submit_curate", T_option_curate);
        ...
        for (MetadataField field : fields) {
            addName.addOption(field.getFieldID(), field.getFieldName().replace(".null", ""));
        }
        ...
        addForm.addItem().addHidden("conceptID").setValue(conceptID);
