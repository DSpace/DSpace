...
public class ItemFilterSet {
     ...
     * @throws SQLException
     */
    public int processSaveItems(Context context, ItemIterator childItems, boolean save, String expand) throws WebApplicationException, SQLException {
     ...
     * @throws SQLException
     */
    public int processSaveItems(Context context, ItemIterator childItems, List<Item> items, boolean save, String expand) throws WebApplicationException, SQLException {
    	int count = 0;
