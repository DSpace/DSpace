...
public class ResourceSyncGenerator
{
	...
	public static List<String> buildHandleForResourceSync(Context context) throws SQLException {
		...
		String capabilityList = new DSpace().getConfigurationService().getProperty("resourcesync.capabilitylists");
			...
			throws IOException
	{
		...
		this.resourceDump = new DSpace().getConfigurationService().getBooleanProperty("resourcesync.resourcedump.enable");

		this.outdir = new DSpace().getConfigurationService().getProperty("resourcesync.dir");
		if (this.outdir == null)
		{
			...
			throws SQLException, IOException
	{
		...
		if (!handle.equals(siteHandle))
		{
			...
			path = new DSpace().getConfigurationService().getProperty("resourcesync.resourcesync.dir");
