...
public class ResourceSyncServlet extends HttpServlet
{
    ...
    private boolean resourcedumpOnTheFly = new DSpace().getConfigurationService().getBooleanProperty("resourcesync.resourcedump.onthefly");
    private boolean changedumpOnTheFly = new DSpace().getConfigurationService().getBooleanProperty("resourcesync.changedump.onthefly");
            ...
            throws IOException
    {
        ...
        String dir = new DSpace().getConfigurationService().getProperty("resourcesync.resourcesync.dir");
        if (dir == null)
        {
            resp.sendError(404);
            return;
