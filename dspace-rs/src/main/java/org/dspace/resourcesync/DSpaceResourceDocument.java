...
public class DSpaceResourceDocument
{
            ...
            throws SQLException
    {
        ...
        boolean isOnlyMetadata = new DSpace().getConfigurationService().getBooleanProperty("resourcesync.resourcedump.onlymetadata");
        if (!isOnlyMetadata)
        {
    ...
    protected List<MetadataFormat> getMetadataFormats()
    {
        ...
        String formatCfg = new DSpace().getConfigurationService().getProperty("resourcesync.metadata.formats");
        String typeCfg = new DSpace().getConfigurationService().getProperty("resourcesync.metadata.types");
    ...
    {
        String cf = new DSpace().getConfigurationService().getProperty("resourcesync.metadata.change-freq");
    ...
    {
        String cf = new DSpace().getConfigurationService().getProperty("resourcesync.bitstream.change-freq");
        if (cf == null || "".equals(cf))
        {
            return null;
        }
    ...
    {
        String baseUrl = new DSpace().getConfigurationService().getProperty("resourcesync.base-url");
	...
	protected String getBitstreamUrl(Bitstream bitstream) {
		String bsLink = new DSpace().getConfigurationService().getProperty("resourcesync.base-url");
    ...
    protected String getCollectionUrl(Collection collection)
    {
        ...
        String base = new DSpace().getConfigurationService().getProperty("dspace.url");
