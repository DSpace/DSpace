...
public class RequestItemRepositoryIT
    ...
    public void testCreateAndReturn()
        ...
        rir.setBitstream_id(bitstream.getID().toString());
        rir.setItem_id(item.getID().toString());
        rir.setRequest_email(RequestItemBuilder.REQ_EMAIL);
        rir.setRequest_message(RequestItemBuilder.REQ_MESSAGE);
        rir.setRequest_name(RequestItemBuilder.REQ_NAME);
