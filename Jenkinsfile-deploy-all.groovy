        ...
        stage('Provide input parameters to confirm deployment') {
            steps {
                script {
					...
					slackSend channel: SLACK_CHANNEL, iconEmoji: ':information_source:', message: 'Deployment av alle Brage-instanser på *' + inputResult + '* starter', username: 'BrageDeployment'
                }
            }
        }
