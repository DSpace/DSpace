...
public class OpenAIRE30ImplicitOpenAccessTest {
    ...
    public OpenAIRE30ImplicitOpenAccessTest(String dc, List<String> value) {
        this.dc = dc;
        this.value = value;
    }
    ...
    public static void setUp() throws Exception {
        result = loadMetadata("/cristinImplicitOpenAccess.xml", TransformerType.OPENAIRE);
    }
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {"dc:relation", Arrays.asList("info:eu-repo/semantics/altIdentifier/issn/1535-9476",
                        "info:eu-repo/semantics/altIdentifier/issn/1122-3345", "info:eu-repo/semantics/altIdentifier/doi/10.1074/mcp.M111.010447")}
        });
    }
