...
//		$text2 = trim(preg_replace("/\h+/", ' ', $text2));
	...
	$text = "Экз тымпор квюаырэндум компрэхэнжам вим. Нэ брутэ молэчтёэ ючю. Ыам пхаэдрум молыжтйаы ан. Ан хёз пожжэ омныз, йн эож ныморэ дежпютатионй.
<coco>
Аэквюы лыгимуз мыа экз, нэ ыррор доминг квюо. Антеопам квюальизквюэ квуй нэ, ыюм вёжи праэчынт кончэтытюр нэ. Пэр ад плььатонэм ажжынтиор, про вёжи дэфянятйоныс эа. Зймюл партйэндо ратионебюж ыт хёз, хёз эзшэ конжыквуюнтюр но. Эож жюмо толлйт праэчынт ад, ку эрож выльёт эррэм квюо, нам анёмал жкрипта запиэнтэм ат. Экз витаэ мюнырэ хэндрэрет вяш.
";
	$text2 = '';
}
