...
<%
    ...
    if (bix.getName() != null) sharedLink += "type=" + URLEncoder.encode(bix.getName(), "UTF-8");
    ...
    if (bix.isMetadataIndex()) typeKey = "browse.type.metadata." + bix.getName();
    else if (bi.getSortOption() != null) typeKey = "browse.type.item." + bi.getSortOption().getName();
    else typeKey = "browse.type.item." + bix.getSortOption().getName();
...
<dspace:layout titlekey="browse.page-title" navbar="<%=layoutNavbar %>">
    ...
    <div id="browse_navigation" class="well text-center">
        ...
        %>
            ...
            <input type="text" name="starts_with"/>&nbsp;<input type="submit" class="btn btn-default"
                                                                value="<fmt:message key="browse.nav.go"/>"/>
            <%
                }
            %>
        </form>
    ...
    <div id="browse_controls" class="well text-center">
        ...
        %>
            ...
            <select name="etal">
                ...
                %>
                <option value="<%= bi.getEtAl() %>" selected="selected"><%= bi.getEtAl() %>
                </option>
                <%
