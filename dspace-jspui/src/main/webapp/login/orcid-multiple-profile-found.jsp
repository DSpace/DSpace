...
<dspace:layout titlekey="jsp.login.orcid-multiple-profile.title">

    <%-- <h1>No User Record Available</h1> --%>
    <h1><fmt:message key="jsp.login.orcid-multiple-profile.title"/></h1>

    
    <p><fmt:message key="jsp.login.orcid-multiple-profile.text">
