...
<dspace:layout titlekey="jsp.login.orcid-multiple.title">

    <h1><fmt:message key="jsp.login.orcid-multiple.title"/></h1>
    
    <p><fmt:message key="jsp.login.orcid-multiple.text">
