...
<dspace:layout locbar="commLink" title="<%= name %>" feedData="<%= feedData %>">
                ...
                <h2><%= name %>
                    ...
                    <div>
                        <form method="get" action="">
                            ...
                            <input class="btn btn-sm btn-warning" type="submit" name="submit_unsubscribe"
                                   value="<fmt:message key="jsp.collection-home.unsub"/>"/>
                            <% } else { %>

                            <input class="btn btn-sm btn-info" type="submit" name="submit_subscribe"
    ...
    %>
    <a href="<%= request.getContextPath() %>/feed/<%= fmts[j] %>/<%= collection.getHandle() %>"><img
            src="<%= request.getContextPath() %>/image/<%= icon %>" alt="RSS Feed" width="<%= width %>" height="15"
            style="margin: 3px 0 3px"/></a>
<%
    } %>
    	</span><%
                            }
            ...
            <% if (logo != null) { %>
            <div class="col-md-4">
                <img class="img-responsive pull-right" alt="Logo"
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <form method="get" class="btn-group"
                  action="<%= request.getContextPath() %>/handle/<%= collection.getHandle() %>/browse">
    ...
    <form class="form-group" action="<%= request.getContextPath() %>/submit" method="post">
        ...
        <input class="btn btn-success col-md-12" type="submit" name="submit"
               value="<fmt:message key="jsp.collection-home.submit.button"/>"/>
    </form>
    <% } %>
   ...
   <%-- <div class="prev-next-links">
    ...
    <dspace:sidebar>
        ...
        %><p class="recentItem"><a
            href="<%= request.getContextPath() %>/handle/<%= items[i].getHandle() %>"><%= displayTitle %>
    </a></p><%
        }
    %>
        <p>&nbsp;</p>
