				...
				<div class="discovery-search-appliedFilters">
					...
					<select id="filter_type_<%=idx %>" name="filter_type_<%=idx %>_select" disabled>
						...
						if (filter[0].equals("type")) {
							filterValue = EssuirUtils.getTypeLocalized(StringEscapeUtils.escapeHtml(filterValue), locale);
						} else if (filter[0].equals("language")) {
							filterValue = EssuirUtils.getLanguageLocalized(StringEscapeUtils.escapeHtml(filterValue), locale);
						}
					%>
					</select>
