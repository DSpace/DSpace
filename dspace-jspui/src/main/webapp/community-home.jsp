        ...
        <div class="row">
            <div>
                <h2><%= name %>
                    ...
                    %>
                    <a href="<%= request.getContextPath() %>/feed/<%= fmts[j] %>/<%= community.getHandle() %>"><img
                    ...
                    <a class="statisticsLink btn btn-info"
                       href="<%= request.getContextPath() %>/handle/<%= community.getHandle() %>/statistics"><fmt:message
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <form method="get" action="<%= request.getContextPath() %>/handle/<%= community.getHandle() %>/browse">
                ...
                <input class="btn btn-default col-md-3" type="submit" name="submit_browse"
        ...
        <div class="list-group-item row">
            ...
            <div class="col-md-3">
                <img alt="Logo" class="img-responsive"
                     src="<%= request.getContextPath() %>/retrieve/<%= logoCom.getID() %>"/>
            </div>
            <div class="col-md-9">
                <% } else { %>
                <div class="col-md-12">
                    ...
                    <h4 class="list-group-item-heading"><a
                        ...
                        <form class="btn-group" method="post"
                            ...
                            <input type="hidden" name="action"
                                   value="<%=EditCommunitiesServlet.START_DELETE_COMMUNITY%>"/>
    ...
    <div class="col-md-6">
        ...
        <div class="list-group">
            ...
            <div class="list-group-item row">
                ...
                <div class="col-md-3">
                    <img alt="Logo" class="img-responsive"
                         src="<%= request.getContextPath() %>/retrieve/<%= logoCol.getID() %>"/>
                </div>
                <div class="col-md-9">
                    <% } else { %>
                    <div class="col-md-12">
