...
<dspace:layout titlekey="jsp.dspace-admin.authority-key.title">
<table width="95%">
    <tr>      
...
<form method="post">
    ...
    <dspace:itemlist items="<%= items_ambiguos %>" disableCrossLinks="true"
                     linkToEdit="false"  radioButton="false" inputName="items_ambiguos" />
    
                   <input type="submit" class="btn btn-default" name="submit_accept" value="<fmt:message key="jsp.dspace-admin.authority-key.accept" />" />
<%
    if (!bRequired)
    {
 %>
    <input type="submit" class="btn btn-warning" name="submit_reject" value="<fmt:message key="jsp.dspace-admin.authority-key.reject" />"  />
<%
    } 
    }
    ...
    <dspace:itemlist items="<%= items_uncertain %>" disableCrossLinks="true"
                     linkToEdit="false"  radioButton="false" inputName="items_uncertain" />
...
<%
    ...
    <dspace:itemlist items="<%= items_novalue %>" disableCrossLinks="true"
                     linkToEdit="false"  radioButton="false" inputName="items_novalue" />
...
<%
    ...
    <dspace:itemlist items="<%= items_failed %>" disableCrossLinks="true"
                     linkToEdit="false"  radioButton="false" inputName="items_failed" />
...
<%
     ...
     <dspace:itemlist items="<%= items_notfound %>" disableCrossLinks="true"
                      linkToEdit="false"  radioButton="false" inputName="items_notfound" />
 ...
 <%
    ...
    <dspace:itemlist items="<%= items_unset %>" disableCrossLinks="true"
                     linkToEdit="false"  radioButton="false" inputName="items_unset" />
...
<%
    ...
    <dspace:itemlist items="<%= items_reject %>" disableCrossLinks="true"
                     linkToEdit="false"  radioButton="false" inputName="items_reject" />
