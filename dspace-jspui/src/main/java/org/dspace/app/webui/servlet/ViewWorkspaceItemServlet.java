...
public class ViewWorkspaceItemServlet extends DSpaceServlet
{
    ...
    private static Logger log = Logger
            .getLogger(ViewWorkspaceItemServlet.class);
            ...
            SQLException, AuthorizeException
    {
        ...
        if (button.equals("submit_view") || button.equals("submit_full")
            ...
            SQLException, AuthorizeException
    {
        ...
        log.info(LogManager.getHeader(c, "View Workspace Item Metadata",
     ...
     *            the servlet response
     */
    private void showErrorPage(Context context, HttpServletRequest request,
            HttpServletResponse response) throws ServletException, IOException,
            SQLException, AuthorizeException
    {
        int wsItemID = UIUtil.getIntParameter(request, "workspace_id");
        ...
        log.error(LogManager.getHeader(context,
                "View Workspace Item Metadata Failed", "workspace_item_id="
                        + wsItemID));
