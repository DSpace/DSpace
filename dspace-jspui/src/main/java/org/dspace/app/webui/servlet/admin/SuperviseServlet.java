 ...
 * @version $Revision$
 */
public class SuperviseServlet extends
        org.dspace.app.webui.servlet.DSpaceServlet
{
            ...
            AuthorizeException
    {
        ...
        JSPManager.showJSP(request, response,
                "/dspace-admin/supervise-confirm-remove.jsp");
     ...
     *            the servlet response
     */
    private void showLinkPage(Context context, HttpServletRequest request,
            HttpServletResponse response) throws ServletException, IOException,
            SQLException, AuthorizeException
    {
        // get all the groups
        ...
        {
            JSPManager.showJSP(request, response,
                    "/dspace-admin/supervise-link.jsp");
        }
    }
    ...
    {
        JSPManager.showJSP(request, response,
                "/dspace-admin/supervise-main.jsp");
    }
     ...
     *            the servlet response
     */
    private void showListPage(Context context, HttpServletRequest request,
            HttpServletResponse response) throws ServletException, IOException,
            SQLException, AuthorizeException
    {
        ...
        JSPManager.showJSP(request, response,
                "/dspace-admin/supervise-list.jsp");
    }
     ...
     *            the servlet response
     */
    void addSupervisionOrder(Context context, HttpServletRequest request,
            HttpServletResponse response) throws SQLException,
            AuthorizeException, ServletException, IOException
    {
        ...
        log.info(LogManager.getHeader(context, "Supervision Order Set",
                "workspace_item_id=" + wsItemID + ",eperson_group_id="
                        + groupID));
     ...
     *            the servlet response
     */
    void removeSupervisionOrder(Context context, HttpServletRequest request,
            HttpServletResponse response) throws SQLException,
            AuthorizeException, ServletException, IOException
    {
