...
/**
 * Servlet for handling a global search.
 * 
 */
public class GlobalSearchServlet extends DSpaceServlet
{
    private SearchRequestProcessor internalLogic;

    /** log4j category */
    private static Logger log = Logger.getLogger(GlobalSearchServlet.class);
            ...
            SQLException, AuthorizeException
    {
        try
        {
            internalLogic.doGlobalSearch(context, request, response);
        }
