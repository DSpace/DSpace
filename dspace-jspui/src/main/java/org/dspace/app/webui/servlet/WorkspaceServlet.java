...
public class WorkspaceServlet extends DSpaceServlet
{
            ...
            SQLException, AuthorizeException
    {
        ...
        log.error(LogManager.getHeader(context, "Workspace Item View Failed",
     ...
     *            the servlet response
     */
    private void goToMyDSpace(Context context, HttpServletRequest request,
            HttpServletResponse response) throws ServletException, IOException,
            SQLException, AuthorizeException
    {
            ...
            SQLException, AuthorizeException
    {
        ...
        log.info(LogManager.getHeader(context, "View Workspace Item",
                "workspace_item_id=" + wsItemID));
