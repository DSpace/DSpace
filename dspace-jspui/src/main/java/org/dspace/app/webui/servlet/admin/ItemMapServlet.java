...
public class ItemMapServlet extends DSpaceServlet
{
            ...
            AuthorizeException
    {
        ...
        if (action.equals("") || !cancel.equals(""))
        {
            ...
            Map<Integer, Item> myItems = new HashMap<Integer, Item>(); // # for
                                                                       // the
                                                                       // browser
            Map<Integer, Collection> myCollections = new HashMap<Integer, Collection>(); // collections
                                                                                         // for
                                                                                         // list
            Map<Integer, Integer> myCounts = new HashMap<Integer, Integer>(); // counts
                                                                              // for
                                                                              // each
                                                                              // collection
            ...
            try
            {
                // iterate through the items in this collection, and count how
                // many
                // are native, and how many are imports, and which collections
                // they
                // came from
                while (i.hasNext())
                {
            ...
            request.setAttribute("all_collections", Collection.findAll(context));
        ...
        else if (action.equals("browse"))
        {
            ...
            request.setAttribute("collection", myCollection);
            request.setAttribute("browsetext",
                    targetCollection.getMetadata("name"));
