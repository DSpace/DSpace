package edu.umd.lib.dspace.app.webui.submit.step;
 ...
 */
public class JSPLibraryAwardUploadStep extends JSPStep
{
    /** JSP to choose files to upload * */
    private static final String CHOOSE_FILE_JSP = "/submit/libraryaward-choose-file.jsp";

    /** JSP to show files that were uploaded * */
    private static final String UPLOAD_LIST_JSP = "/submit/libraryaward-upload-file-list.jsp";
    ...
    /** log4j logger */
    private static Logger log = Logger.getLogger(JSPLibraryAwardUploadStep.class);
