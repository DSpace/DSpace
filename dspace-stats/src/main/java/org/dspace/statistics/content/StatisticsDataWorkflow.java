...
public class StatisticsDataWorkflow extends StatisticsData {
    ...
    protected Date getOldestWorkflowItemDate() throws SolrServerException {
        ...
        String workflowStartDate = configurationService.getProperty("solr-statistics.workflow-start-date");
            ...
            if(0 < oldestRecord.getResults().getNumFound()){
                ...
                try {
                    ...
                    String solrConfigDir = configurationService.getProperty("dspace.dir") + File.separator + "config"
                            + File.separator + "modules" + File.separator + "solr-statistics.cfg";
                ...
                configurationService.setProperty("solr-statistics.workflow-start-date", new DCDate(oldestDate).toString());
