...
/**
 * Test class to generate random statistics data. Used for load testing of
 * searches. Inputs are slow due to inefficient randomizer.
 * 
...
public class StatisticsDataGenerator
{
    public static void main(String[] args) throws Exception
    {
        ...
        for (int i = 0; i < nrLogs; i++)
        {
            ...
            doc1.addField("time",
                    DateFormatUtils.format(time, SolrLogger.DATE_FORMAT_8601));

            if (epersonId > 0)
                doc1.addField("epersonid", epersonId);
                        
                        
            doc1.addField("isBot", RandomUtils.nextBoolean());
            ...
            {
                solrServiceIndexPlugin.additionalIndex(null, dso, doc1);
            }
