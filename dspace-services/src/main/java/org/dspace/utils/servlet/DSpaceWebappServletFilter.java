...
public final class DSpaceWebappServletFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        try {
            ...
            // no kernel so we die
            String message = "Could not start up DSpaceWebappServletFilter because the DSpace Kernel is unavailable " +
                "or not running: " + e
                .getMessage();
    ...
    /* (non-Javadoc)
     * @see jakarta.servlet.Filter#doFilter(jakarta.servlet.ServletRequest, jakarta.servlet.ServletResponse, jakarta.servlet
     * .FilterChain)
     */
    @Override
